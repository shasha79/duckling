...
classifiers
  = HashMap.fromList
      [("<cycle> (que vem)",
       ...
       ("integer (numeric)",
        Classifier{okData =
                     ClassData{prior = -0.7017309242513368, unseen = -4.0943445622221,
                               likelihoods = HashMap.fromList [("", 0.0)], n = 58},
                   koData =
                     ClassData{prior = -0.6846364908920367, unseen = -4.110873864173311,
       ...
       ("intersect by `da` or `de`",
        Classifier{okData =
                     ClassData{prior = -1.875141078167106, unseen = -4.718498871295094,
                               likelihoods =
                                 HashMap.fromList
                                   [("daymonth", -2.917770732084279),
                                    ...
                                    ("Quart-feira<cycle> (que vem)", -4.0163830207523885),
                                    ("dayyear", -2.0704728716970755),
                                    ("dd-dd <month>(interval)year", -4.0163830207523885),
                                    ("day of month (1st)Mar\231o", -3.3232358401924436),
                                    ("two time tokens separated by \",\"2year",
                                     -3.6109179126442243),
                                    ("intersectyear", -4.0163830207523885),
                                    ("<day-of-month> de <named-month>year", -2.630088659632498),
                                    ("dia <day-of-month> (non ordinal)Fevereiro",
                                     -3.6109179126442243),
                                    ("two time tokens separated by \",\"year", -3.6109179126442243),
                                    ("dayweek", -3.6109179126442243),
                                    ("Quart-feiraproximo <cycle> ", -4.0163830207523885)],
                               n = 23},
                   koData =
                     ClassData{prior = -0.16644820763766446,
                               unseen = -5.768320995793772,
                               likelihoods =
                                 HashMap.fromList
                                   [("time-of-day (latent)<datetime> - <datetime> (interval)",
                                     -4.666578814116735),
                                    ("hourday", -2.9319777587286286),
                                    ("year (latent)Abril", -4.666578814116735),
                                    ("year (latent)Julho", -3.9734316335567894),
                                    ("time-of-day (latent)Fevereiro", -3.8192809537295314),
                                    ("monthday", -4.378896741664954),
                                    ("monthyear", -3.5679665254486252),
                                    ("yearhour", -3.6857495611050086),
                                    ("houryear", -3.126133773169586),
                                    ("year (latent)Maio", -4.155753190350744),
                                    ("time-of-day (latent)two time tokens separated by \",\"2",
                                     -4.666578814116735),
                                    ("Setembroyear", -3.9734316335567894),
                                    ("time-of-day (latent)Setembro", -3.9734316335567894),
                                    ("time-of-day (latent)intersect", -3.126133773169586),
                                    ("year (latent)<time-of-day> <part-of-day>",
                                     -5.072043922224899),
                                    ("\224s <time-of-day>Julho", -5.072043922224899),
                                    ("year (latent)intersect", -4.378896741664954),
                                    ...
                                    ("year (latent)amanh\227 pela <part-of-day>",
                                     -5.072043922224899),
                                    ("hourmonth", -1.8939900918769537),
                                    ("time-of-day (latent)intersect by `da` or `de`",
                                     -3.280284452996844),
                                    ("monthmonth", -5.072043922224899),
                                    ("Setembrotwo time tokens separated by \",\"2",
                                     -5.072043922224899),
                                    ("year (latent)Fevereiro", -3.8192809537295314),
                                    ("time-of-day (latent)Dezembro", -5.072043922224899),
                                    ("dayyear", -5.072043922224899),
                                    ("time-of-day (latent)Julho", -4.155753190350744),
                                    ("time-of-day (latent)Abril", -4.666578814116735),
                                    ("de <datetime> - <datetime> (interval)Janeiro",
                                     -5.072043922224899),
                                    ("year (latent)<dim time> da manha", -5.072043922224899),
                                    ("time-of-day (latent)Mar\231o", -3.9734316335567894),
                                    ("year (latent)Janeiro", -5.072043922224899),
                                    ("year (latent)Dezembro", -5.072043922224899),
                                    ("yearmonth", -2.3639937211226894),
                                    ("two time tokens separated by \",\"2year", -4.666578814116735),
                                    ...
                                    ("intersect by `da` or `de`two time tokens separated by \",\"2",
                                     -5.072043922224899),
                                    ("time-of-day (latent)Maio", -4.155753190350744),
                                    ("<day-of-month> de <named-month>year", -5.072043922224899),
                                    ("Maioyear", -4.666578814116735),
                                    ("year (latent)Setembro", -3.9734316335567894),
                                    ("\224s <time-of-day>Janeiro", -5.072043922224899),
                                    ("two time tokens separated by \",\"year", -4.666578814116735),
                                    ("Domingo<cycle> passado", -5.072043922224899),
                                    ("time-of-day (latent)two time tokens separated by \",\"",
                                     -4.666578814116735),
                                    ("dayweek", -5.072043922224899),
                                    ("intersect by `da` or `de`year", -3.5679665254486252),
                                    ("year (latent)<datetime> - <datetime> (interval)",
                                     -4.666578814116735),
                                    ("yearday", -5.072043922224899),
                                    ("time-of-day (latent)Janeiro", -5.072043922224899),
                                    ("Julhoyear", -5.072043922224899),
                                    ("year (latent)Mar\231o", -3.9734316335567894)],
                               n = 127}}),
                               ...
                               likelihoods =
                                 HashMap.fromList
                                   [("integer (numeric)mes (grain)", -1.6094379124341003),
                                    ("integer (numeric)ano (grain)", -1.6094379124341003),
        ...
        Classifier{okData =
                     ClassData{prior = -0.40546510810816444,
                               ...
                               likelihoods =
                                 HashMap.fromList
                                   [("integer (numeric)ano (grain)", -1.6094379124341003),
                                    ("integer (0..19)mes (grain)", -1.6094379124341003),
                                    ("year", -1.6094379124341003), ("month", -1.6094379124341003)],
                               n = 2},
                   koData =
                     ClassData{prior = -1.0986122886681098,
                               ...
                               likelihoods =
                                 HashMap.fromList
                                   [("second", -1.6094379124341003),
                                    ("integer (numeric)minutos (grain)", -1.6094379124341003),
                                    ("integer (numeric)segundo (grain)", -1.6094379124341003),
                   ...
                   koData =
                     ClassData{prior = -1.0986122886681098,
                               ...
                               likelihoods =
                                 HashMap.fromList
                                   [("week", -1.3862943611198906),
                                    ("integer (0..19)semana (grain)", -1.3862943611198906)],
                               n = 1}}),
       ("this <time>",
        Classifier{okData =
