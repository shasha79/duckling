       ...
       ("intersect",
        Classifier{okData =
                     ClassData{prior = -0.37320424588994294,
                               ...
                               likelihoods =
                                 HashMap.fromList
                                   [("hourday", -2.670309873119363),
                                    ("dayhour", -4.174387269895637),
                                    ("daymonth", -3.258096538021482),
                                    ("monthyear", -3.7689221617874726),
                                    ("the <day-of-month> (ordinal)in <named-month>",
                                     -3.7689221617874726),
                                    ("\1488\1493\1511\1496\1493\1489\1512year", -4.174387269895637),
                                    ("intersect<time-of-day> am|pm", -4.174387269895637),
                                    ("<time> <part-of-day>\1489 <named-day>", -3.481240089335692),
                                    ("intersect by \",\"<time-of-day> am|pm", -3.258096538021482),
                                    ("last <day-of-week> of <time>year", -4.174387269895637),
                                    ("dayday", -2.7880929087757464),
                                    ("the <day-of-month> (ordinal)\1489 <date>",
                                     -3.7689221617874726),
                                    ("dayyear", -2.382627800667582),
                                    ("<day-of-month>(ordinal) <named-month>year",
                                     -3.7689221617874726),
                                    ("\1489 <date>\1489 <named-day>", -4.174387269895637),
                                    ("absorption of , after named day<named-month> <day-of-month> (non ordinal)",
                                     -4.174387269895637),
                                    ("todaythis evening", -4.174387269895637),
                                    ("absorption of , after named day<day-of-month> (ordinal) of <named-month>",
                                     -4.174387269895637),
                                    ("<day-of-month> (ordinal) of <named-month>year",
                                     -3.481240089335692),
                                    ("named-daynext <cycle>", -4.174387269895637),
                                    ...
                                    ("absorption of , after named dayintersect by \",\"",
                                     -3.7689221617874726),
                                    ("year<time-of-day> am|pm", -4.174387269895637),
                                    ("\1489 <date>\1489 <date>", -4.174387269895637),
                                    ...
                                    ("\1502\1512\1509year", -4.174387269895637),
                                    ("<time> <part-of-day>\1489 <date>", -3.481240089335692),
                                    ("named-daythe <day-of-month> (ordinal)", -4.174387269895637),
                                    ("<day-of-month> (non ordinal) <named-month>year",
                                     -3.7689221617874726),
                                    ("yearminute", -4.174387269895637)],
                               n = 42},
                   koData =
                     ClassData{prior = -1.1664348850068706, unseen = -4.442651256490317,
                               likelihoods =
                                 HashMap.fromList
                                   [("in <named-month>year", -3.7376696182833684),
                                    ("daymonth", -3.044522437723423),
                                    ("monthyear", -2.639057329615259),
                                    ("intersecthh:mm", -3.7376696182833684),
                                    ("dayday", -3.7376696182833684),
                                    ("intersect by \",\"hh:mm", -2.8213788864092133),
                                    ("hourhour", -3.7376696182833684),
                                    ("\1488\1508\1512\1497\1500year", -3.7376696182833684),
                                    ("named-dayin <named-month>", -3.7376696182833684),
                                    ("at <time-of-day>this morning", -3.7376696182833684),
                                    ("dayminute", -2.3513752571634776),
                                    ("named-day\1489 <date>", -3.332204510175204),
                                    ("absorption of , after named dayintersect",
                                     -3.7376696182833684),
                                    ("yearhh:mm", -3.7376696182833684),
                                    ("absorption of , after named dayintersect by \",\"",
                                     -3.7376696182833684),
                                    ("dayweek", -3.7376696182833684),
                                    ("\1502\1512\1509year", -3.332204510175204),
                                    ("\1489 <date>year", -3.7376696182833684),
                                    ("named-daythe <day-of-month> (ordinal)", -3.7376696182833684),
                                    ("absorption of , after named day\1497\1493\1500\1497",
                                     -3.7376696182833684),
                                    ("yearminute", -3.7376696182833684)],
                               n = 19}}),
       ("year (grain)",
        Classifier{okData =
                     ClassData{prior = 0.0, unseen = -1.0986122886681098,
