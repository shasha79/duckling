...
classifiers
  = HashMap.fromList
      [("\1502\1512\1509",
       ...
       ("\1489 <date>",
        Classifier{okData =
                     ClassData{prior = -0.2231435513142097, unseen = -4.127134385045092,
                               likelihoods =
                                 HashMap.fromList
                               ...
                               likelihoods =
                                 HashMap.fromList
                                   [("dayhour", -1.4213856809311607),
                                    ...
                                    ("tomorrowevening|night", -2.268683541318364)],
                               n = 9},
                   koData =
                               ...
                               likelihoods =
                                 HashMap.fromList
                                   [("dayhour", -1.6094379124341003),
                                    ("yesterdayevening|night", -2.0149030205422647),
       ...
       ("intersect",
        Classifier{okData =
                     ClassData{prior = -0.3973017974690035, unseen = -4.844187086458591,
                               likelihoods =
                                 HashMap.fromList
                                   [("hourday", -2.639057329615259),
                                    ("daymonth", -3.2268439945173775),
                                    ("monthyear", -3.7376696182833684),
                                    ("the <day-of-month> (ordinal)in <named-month>",
                                     -3.7376696182833684),
                                    ("\1488\1493\1511\1496\1493\1489\1512year", -4.143134726391533),
                                    ("intersect<time-of-day> am|pm", -4.143134726391533),
                                    ("<time> <part-of-day>\1489 <named-day>", -3.4499875458315876),
                                    ("intersect by \",\"<time-of-day> am|pm", -3.2268439945173775),
                                    ("last <day-of-week> of <time>year", -4.143134726391533),
                                    ...
                                    ("<day-of-month>(ordinal) <named-month>year",
                                     -3.7376696182833684),
                                    ("\1489 <date>\1489 <named-day>", -4.143134726391533),
                                    ...
                                    ("<day-of-month> (ordinal) of <named-month>year",
                                     -3.4499875458315876),
                                    ("named-daynext <cycle>", -4.143134726391533),
                                    ...
                                    ("absorption of , after named dayintersect by \",\"",
                                     -3.7376696182833684),
                                    ("year<time-of-day> am|pm", -4.143134726391533),
                                    ("\1489 <date>\1489 <date>", -4.143134726391533),
                                    ...
                                    ("\1502\1512\1509year", -4.143134726391533),
                                    ("<time> <part-of-day>\1489 <date>", -3.4499875458315876),
                                    ("named-daythe <day-of-month> (ordinal)", -4.143134726391533),
                                    ("<day-of-month> (non ordinal) <named-month>year",
                                     -3.7376696182833684),
                                    ("yearminute", -4.143134726391533)],
                               n = 41},
                   koData =
                     ClassData{prior = -1.1151415906193203, unseen = -4.442651256490317,
                               likelihoods =
                                 HashMap.fromList
                                   [("in <named-month>year", -3.7376696182833684),
                                    ...
                                    ("absorption of , after named day\1497\1493\1500\1497",
                                     -3.7376696182833684),
                                    ("tomorrownoon", -3.332204510175204),
