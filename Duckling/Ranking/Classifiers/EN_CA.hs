...
classifiers
  = HashMap.fromList
      [("Bhai Dooj",
       ...
       ("integer (numeric)",
        Classifier{okData =
                     ClassData{prior = -0.6599215329316249, unseen = -5.730099782973574,
                               likelihoods = HashMap.fromList [("", 0.0)], n = 306},
                   koData =
                     ClassData{prior = -0.7275148240641531, unseen = -5.662960480135946,
       ...
       ("integer (0..19)",
        Classifier{okData =
                     ClassData{prior = -5.310982531394841e-2,
                               unseen = -4.04305126783455,
                               likelihoods = HashMap.fromList [("", 0.0)], n = 55},
                   koData =
                     ClassData{prior = -2.9618307218783095,
       ...
       ("intersect",
        Classifier{okData =
                     ClassData{prior = -0.49195713946160785,
                               unseen = -6.762729506931879,
                               likelihoods =
                                 HashMap.fromList
                                   [("Navaratriyear (latent)", -6.068425588244111),
                                    ...
                                    ("Octoberyear (latent)", -4.969813299576001),
                                    ...
                                    ("<time-of-day> o'clockin|during the <part-of-day>",
                                     -6.068425588244111),
                                    ("Thursdayat <time-of-day>", -5.375278407684165),
                                    ...
                                    ("<day-of-month> (ordinal or number) of <named-month>in|during the <part-of-day>",
                                     -6.068425588244111),
                                    ("Septemberyear (latent)", -6.068425588244111),
                               ...
                               n = 321},
                   koData =
                     ClassData{prior = -0.9452782687474074, unseen = -6.447305862541213,
                               likelihoods =
                                 HashMap.fromList
                                   [("<time-of-day> - <time-of-day> (interval)on <date>",
                                     -4.836281906951478),
                                    ("hourday", -4.836281906951478),
                                    ("dayhour", -3.1135153092103742),
                                    ("Tuesdayfrom|since|after <time>", -5.752572638825633),
                                    ("daymonth", -3.7376696182833684),
                                    ("monthyear", -4.047824546587208),
                                    ("<time-of-day> am|pmyear (latent)", -5.3471075307174685),
                                    ("Thai Pongalyear (latent)", -5.059425458265688),
                                    ("intersecthh:mm", -5.752572638825633),
                                    ("from <datetime> - <datetime> (interval)July",
                                     -5.752572638825633),
                                    ("houryear", -4.836281906951478),
                                    ("from <time-of-day> - <time-of-day> (interval)July",
                                     -5.752572638825633),
                                    ("<time-of-day> am|pmintersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.059425458265688),
                                    ("<time-of-day> am|pmintersect", -4.499809670330265),
                                    ("until <time>on <date>", -5.059425458265688),
                                    ("Octoberyear (latent)", -4.836281906951478),
                                    ("<named-month>|<named-day> <day-of-month> (ordinal)year (latent)",
                                     -5.059425458265688),
                                    ("about|exactly <time-of-day>year (latent)",
                                     -5.752572638825633),
                                    ("absorption of , after named dayJuly", -5.3471075307174685),
                                    ("from|since|after <time>July", -5.752572638825633),
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"year (latent)",
                                     -4.836281906951478),
                                    ("Clean Mondayyear (latent)", -5.752572638825633),
                                    ("monthhour", -5.752572638825633),
                                    ("hourmonth", -4.836281906951478),
                                    ("todayat <time-of-day>", -5.752572638825633),
                                    ("from|since|after <time>December", -5.752572638825633),
                                    ("from|since|after <time><time-of-day> am|pm",
                                     -5.752572638825633),
                                    ("Mondayyear (latent)", -5.059425458265688),
                                    ("dayday", -5.3471075307174685),
                                    ("mm/ddat <time-of-day>", -5.3471075307174685),
                                    ("<time-of-day> am|pmon <date>", -4.499809670330265),
                                    ("dayyear", -2.8622008809294686),
                                    ("Thursdaymm/dd", -5.752572638825633),
                                    ("New Year's Dayyear (latent)", -5.3471075307174685),
                                    ("Thursdayfrom|since|after <time>", -4.047824546587208),
                                    ("Thursdayat <time-of-day>", -4.143134726391533),
                                    ("<integer> to|till|before <hour-of-day>September",
                                     -5.752572638825633),
                                    ("Aprilyear (latent)", -5.752572638825633),
                                    ("monthminute", -5.752572638825633),
                                    ("<time-of-day> am|pmtomorrow", -5.752572638825633),
                                    ("Thursdayhh:mm", -4.836281906951478),
                                    ("minutemonth", -3.960813169597578),
                                    ("Augustyear (latent)", -5.3471075307174685),
                                    ("Thursdayfrom <datetime> - <datetime> (interval)",
                                     -5.3471075307174685),
                                    ("Thursdayfrom <time-of-day> - <time-of-day> (interval)",
                                     -5.3471075307174685),
                                    ("week-endin|during <named-month>|year", -5.752572638825633),
                                    ("mm/dd<time-of-day> - <time-of-day> (interval)",
                                     -5.3471075307174685),
                                    ("tomorrowfrom <time-of-day> - <time-of-day> (interval)",
                                     -5.752572638825633),
                                    ("Sundayyear (latent)", -4.836281906951478),
                                    ("Christmasat <time-of-day>", -5.752572638825633),
                                    ("from|since|after <time>year (latent)", -4.653960350157523),
                                    ("<duration> after|before|from <time>December",
                                     -5.752572638825633),
                                    ("yesterday<time-of-day> am|pm", -5.752572638825633),
                                    ("Septemberyear (latent)", -5.752572638825633),
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"hh:mm",
                                     -5.752572638825633),
                                    ("mm/ddyear (latent)", -5.752572638825633),
                                    ("Thursday<time-of-day> - <time-of-day> (interval)",
                                     -5.059425458265688),
                                    ...
                                    ("<ordinal> last <cycle> of <time>year (latent)",
                                     -5.3471075307174685),
                                    ("at <time-of-day>intersect", -5.3471075307174685),
                                    ("hh:mmyear (latent)", -4.653960350157523),
                                    ("Holiyear (latent)", -5.752572638825633),
                                    ("the <day-of-month> (ordinal)last <cycle> of <time>",
                                     -5.3471075307174685),
                                    ("until <time><time-of-day> am|pm", -5.752572638825633),
                                    ("at <time-of-day>intersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.752572638825633),
                                    ("dayminute", -2.979983916585852),
                                    ("yyyy-mm-ddhh:mm", -5.3471075307174685),
                                    ("intersectSeptember", -4.248495242049359),
                                    ("minuteday", -2.684519703692016),
                                    ("absorption of , after named dayintersect",
                                     -5.752572638825633),
                                    ("Februaryin|during the <part-of-day>", -5.752572638825633),
                                    ("<ordinal> <cycle> of <time>year (latent)",
                                     -5.752572638825633),
                                    ("the <day-of-month> (ordinal)this|last|next <cycle>",
                                     -5.3471075307174685),
                                    ("hh:mmon <date>", -3.7376696182833684),
                                    ("Saturdayyear (latent)", -5.752572638825633),
                                    ("from|since|after <time>on <date>", -4.836281906951478),
                                    ("absorption of , after named daySeptember",
                                     -4.836281906951478),
                                    ("Naraka Chaturdashiyear (latent)", -5.752572638825633),
                                    ("on <date>September", -5.3471075307174685),
                                    ("at <time-of-day>on <date>", -5.3471075307174685),
                                    ("dayweek", -4.653960350157523),
                                    ("Easter Sundayyear (latent)", -5.3471075307174685),
                                    ("Thursday<time-of-day> am|pm", -4.653960350157523),
                                    ("weekyear", -4.366278277705742),
                                    ...
                                    ("intersect by \",\", \"of\", \"from\" for yearhh:mm",
                                     -5.059425458265688),
                                    ("Sundayfrom|since|after <time>", -5.752572638825633),
                                    ("absorption of , after named dayFebruary", -4.836281906951478),
                                    ("July<integer> to|till|before <hour-of-day>",
                                     -5.752572638825633),
                                    ("tomorrowat <time-of-day>", -5.752572638825633),
                                    ("<integer> to|till|before <hour-of-day>July",
                                     -5.752572638825633),
                                    ("last <cycle> of <time>year (latent)", -5.059425458265688),
                                    ("tomorrow<time-of-day> am|pm", -5.752572638825633),
                                    ("<named-month> <day-of-month> (non ordinal)year (latent)",
                                     -5.059425458265688),
                                    ("Diwaliyear (latent)", -5.3471075307174685),
                                    ("the <ordinal> last <cycle> of <time>year (latent)",
                                     -5.752572638825633),
                                    ("<time-of-day> - <time-of-day> (interval)July",
                                     -5.752572638825633),
                                    ("Fridayyear (latent)", -5.3471075307174685),
                                    ("minuteyear", -4.499809670330265)],
                               n = 204}}),
       ("one eleven",
        Classifier{okData =
       ...
       ("year (latent)",
        Classifier{okData =
                     ClassData{prior = -0.18457127652797004,
                               ...
                               n = 148},
                   koData =
                     ClassData{prior = -1.7805861686299298,
       ...
       ("this|last|next <cycle>",
        Classifier{okData =
                     ClassData{prior = -0.6286086594223742, unseen = -4.672828834461907,
                               likelihoods =
                                 HashMap.fromList
                                   [("week", -1.4853852637641216),
                                    ("month (grain)", -2.3608540011180215),
                                    ("year (grain)", -2.0984897366505306),
                                    ("week (grain)", -1.4853852637641216),
                                    ("quarter", -3.054001181677967), ("year", -2.0984897366505306),
                                    ("month", -2.3608540011180215),
                                    ("quarter (grain)", -3.054001181677967)],
                               n = 48},
                   koData =
                     ClassData{prior = -0.7621400520468967, unseen = -4.553876891600541,
                               likelihoods =
                                 HashMap.fromList
       ...
       ("<integer> <unit-of-duration>",
        Classifier{okData =
                     ClassData{prior = -0.18924199963852842,
                               ...
                               likelihoods =
                                 HashMap.fromList
                                   [("week", -2.908720896564361),
                                    ("integer (0..19)year (grain)", -2.908720896564361),
                                    ("integer (numeric)day (grain)", -2.540996116439044),
                                    ("integer (0..19)second (grain) ", -3.71965111278069),
                                    ("integer (0..19)hour (grain)", -3.0265039322207445),
                                    ("second", -3.3141860046725258),
                                    ("integer (numeric)second (grain) ", -4.007333185232471),
                                    ("integer (numeric)year (grain)", -3.3141860046725258),
                                    ("day", -2.2727321298443646), ("year", -2.466888144285322),
                                    ("integer (numeric)week (grain)", -3.4965075614664802),
                                    ("integer (0..19)month (grain)", -3.4965075614664802),
                                    ("hour", -2.6210388241125804), ("month", -3.1600353248452673),
                                    ("integer (numeric)minute (grain)", -3.1600353248452673),
                                    ("integer (0..19)minute (grain)", -3.0265039322207445),
                                    ("integer (numeric)month (grain)", -4.007333185232471),
                                    ("minute", -2.466888144285322),
                                    ("integer (numeric)hour (grain)", -3.4965075614664802),
                                    ("integer (0..19)day (grain)", -3.4965075614664802),
                                    ("integer (0..19)week (grain)", -3.4965075614664802)],
                               n = 72},
                   koData =
                     ClassData{prior = -1.7578579175523736, unseen = -3.951243718581427,
                               likelihoods =
                                 HashMap.fromList
       ...
       ("intersect by \",\", \"of\", \"from\", \"'s\"",
        Classifier{okData =
                     ClassData{prior = -0.5768873744440833, unseen = -4.941642422609305,
                               likelihoods =
                                 HashMap.fromList
                                   [("Wednesday<named-month> <day-of-month> (non ordinal)",
                                     -4.241326752570746),
                                    ("dayhour", -3.835861644462582),
                                    ("daymonth", -2.9885637840753785),
                                    ("<named-month> <day-of-month> (non ordinal)Friday",
                                     -4.241326752570746),
                                    ("Friday<named-month> <day-of-month> (non ordinal)",
                                     -3.548179572010801),
                                    ("Wednesdayintersect", -4.241326752570746),
                                    ("Black Fridaythis|last|next <cycle>", -4.241326752570746),
                                    ("Labour Daythis|last|next <cycle>", -4.241326752570746),
                                    ("<part-of-day> of <time>February", -4.241326752570746),
                                    ("Saturday<time-of-day> am|pm", -4.241326752570746),
                                    ("Martin Luther King's Daythis|last|next <cycle>",
                                     -3.835861644462582),
                                    ("on <date><time-of-day> am|pm", -4.241326752570746),
                                    ("hourmonth", -4.241326752570746),
                                    ("Fridayintersect by \",\", \"of\", \"from\" for year",
                                     -4.241326752570746),
                                    ("dayday", -2.369524575669155),
                                    ("the <day-of-month> (ordinal)February", -3.835861644462582),
                                    ("WednesdayOctober", -4.241326752570746),
                                    ("Wednesdaythis|last|next <cycle>", -3.835861644462582),
                                    ("intersect<named-month> <day-of-month> (non ordinal)",
                                     -3.3250360206965914),
                                    ("dayyear", -3.1427144639026365),
                                    ("Saturday<named-month> <day-of-month> (non ordinal)",
                                     -4.241326752570746),
                                    ("Thursdayhh:mm", -3.835861644462582),
                                    ("Thanksgiving Daythis|last|next <cycle>", -4.241326752570746),
                                    ("on <date><named-month> <day-of-month> (non ordinal)",
                                     -3.835861644462582),
                                    ("TuesdayOctober", -4.241326752570746),
                                    ("the <day-of-month> (ordinal)March", -4.241326752570746),
                                    ("Mondaythis|last|next <cycle>", -4.241326752570746),
                                    ("Fridayintersect", -4.241326752570746),
                                    ("Thursday<datetime> - <datetime> (interval)",
                                     -3.835861644462582),
                                    ("Thursday<time-of-day> - <time-of-day> (interval)",
                                     -3.835861644462582),
                                    ("Tuesdaythis|last|next <cycle>", -4.241326752570746),
                                    ("Sunday<named-month> <day-of-month> (non ordinal)",
                                     -4.241326752570746),
                                    ("dayminute", -2.8550323914508557),
                                    ("minuteday", -3.3250360206965914),
                                    ("dayweek", -3.3250360206965914),
                                    ("Monday<named-month> <day-of-month> (non ordinal)",
                                     -3.835861644462582)],
                               n = 41},
                   koData =
                     ClassData{prior = -0.8247235383486646, unseen = -4.804021044733257,
                               likelihoods =
                                 HashMap.fromList
                                   [("week-endJuly", -4.102643365036796),
                                    ...
                                    ("this|last|next <cycle>Sunday", -4.102643365036796),
                                    ("Sundaythis|last|next <cycle>", -4.102643365036796),
                                    ("MondayMarch", -4.102643365036796),
                                    ("on <date>September", -3.6971782569286313),
                                    ("weekday", -4.102643365036796),
                                    ("dayweek", -4.102643365036796),
