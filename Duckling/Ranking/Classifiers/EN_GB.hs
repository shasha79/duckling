...
classifiers
  = HashMap.fromList
      [("Bhai Dooj",
       ...
       ("integer (numeric)",
        Classifier{okData =
                     ClassData{prior = -0.6846653655040362, unseen = -5.697093486505405,
                               likelihoods = HashMap.fromList [("", 0.0)], n = 296},
                   koData =
                     ClassData{prior = -0.7017015526566039, unseen = -5.680172609017068,
       ...
       ("intersect",
        Classifier{okData =
                     ClassData{prior = -0.5101823300802489, unseen = -6.734591659972948,
                               likelihoods =
                                 HashMap.fromList
                                   [("Navaratriyear (latent)", -6.040254711277414),
                                    ...
                                    ("this <time>hh(:mm) - <time-of-day> am|pm",
                                     -6.040254711277414),
                                    ("yyyy-mm-ddhh:mm:ss", -5.634789603169249),
                                    ...
                                    ("<time-of-day> o'clockin|during the <part-of-day>",
                                     -6.040254711277414),
                                    ("Thursdayat <time-of-day>", -5.3471075307174685),
                               ...
                               n = 311},
                   koData =
                     ClassData{prior = -0.9172564489941141, unseen = -6.450470422144176,
                               likelihoods =
                                 HashMap.fromList
                                   [("<time-of-day> - <time-of-day> (interval)on <date>",
                                     -4.839451481712757),
                                    ("hourday", -4.839451481712757),
                                    ("dayhour", -3.1166848839716534),
                                    ("Tuesdayfrom|since|after <time>", -5.755742213586912),
                                    ("daymonth", -3.740839193044647),
                                    ("monthyear", -4.050994121348487),
                                    ("<time-of-day> am|pmyear (latent)", -5.350277105478748),
                                    ("Thai Pongalyear (latent)", -5.062595033026967),
                                    ("intersecthh:mm", -5.755742213586912),
                                    ("from <datetime> - <datetime> (interval)July",
                                     -5.755742213586912),
                                    ("houryear", -4.839451481712757),
                                    ("from <time-of-day> - <time-of-day> (interval)July",
                                     -5.755742213586912),
                                    ("<time-of-day> am|pmintersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.062595033026967),
                                    ("<time-of-day> am|pmintersect", -4.502979245091544),
                                    ("until <time>on <date>", -5.062595033026967),
                                    ("Octoberyear (latent)", -4.839451481712757),
                                    ("<named-month>|<named-day> <day-of-month> (ordinal)year (latent)",
                                     -5.062595033026967),
                                    ("about|exactly <time-of-day>year (latent)",
                                     -5.755742213586912),
                                    ("absorption of , after named dayJuly", -5.350277105478748),
                                    ("from|since|after <time>July", -5.755742213586912),
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"year (latent)",
                                     -4.839451481712757),
                                    ("Clean Mondayyear (latent)", -5.755742213586912),
                                    ("monthhour", -5.755742213586912),
                                    ("hourmonth", -4.839451481712757),
                                    ("todayat <time-of-day>", -5.755742213586912),
                                    ("Bank Holidayyear (latent)", -5.062595033026967),
                                    ("from|since|after <time>December", -5.755742213586912),
                                    ("from|since|after <time><time-of-day> am|pm",
                                     -5.755742213586912),
                                    ("Mondayyear (latent)", -5.062595033026967),
                                    ("dayday", -5.350277105478748),
                                    ("dd/mmat <time-of-day>", -5.350277105478748),
                                    ("<time-of-day> am|pmon <date>", -4.502979245091544),
                                    ("Thursdaydd/mm", -5.755742213586912),
                                    ("dayyear", -2.785327748017211),
                                    ("New Year's Dayyear (latent)", -5.350277105478748),
                                    ("Thursdayfrom|since|after <time>", -4.050994121348487),
                                    ("Thursdayat <time-of-day>", -4.146304301152812),
                                    ("<integer> to|till|before <hour-of-day>September",
                                     -5.755742213586912),
                                    ("Aprilyear (latent)", -5.755742213586912),
                                    ("monthminute", -5.755742213586912),
                                    ("<time-of-day> am|pmtomorrow", -5.755742213586912),
                                    ("Thursdayhh:mm", -4.839451481712757),
                                    ("minutemonth", -3.963982744358857),
                                    ("Augustyear (latent)", -5.350277105478748),
                                    ("Thursdayfrom <datetime> - <datetime> (interval)",
                                     -5.350277105478748),
                                    ("Thursdayfrom <time-of-day> - <time-of-day> (interval)",
                                     -5.350277105478748),
                                    ("week-endin|during <named-month>|year", -5.755742213586912),
                                    ("tomorrowfrom <time-of-day> - <time-of-day> (interval)",
                                     -5.755742213586912),
                                    ("dd/mm<time-of-day> - <time-of-day> (interval)",
                                     -5.350277105478748),
                                    ("Sundayyear (latent)", -4.839451481712757),
                                    ("Christmasat <time-of-day>", -5.755742213586912),
                                    ("from|since|after <time>year (latent)", -4.657129924918802),
                                    ("dd/mmyear (latent)", -5.755742213586912),
                                    ("<duration> after|before|from <time>December",
                                     -5.755742213586912),
                                    ("yesterday<time-of-day> am|pm", -5.755742213586912),
                                    ("Septemberyear (latent)", -5.755742213586912),
                                    ...
                                    ("hh:mmyear (latent)", -4.657129924918802),
                                    ("Holiyear (latent)", -5.755742213586912),
                                    ("the <day-of-month> (ordinal)last <cycle> of <time>",
                                     -5.350277105478748),
                                    ("until <time><time-of-day> am|pm", -5.755742213586912),
                                    ("at <time-of-day>intersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.755742213586912),
                                    ("dayminute", -2.9831534913471307),
                                    ("yyyy-mm-ddhh:mm", -5.350277105478748),
                                    ("intersectSeptember", -4.251664816810638),
                                    ("minuteday", -2.687689278453295),
                                    ("absorption of , after named dayintersect",
                                     -5.755742213586912),
                                    ("Februaryin|during the <part-of-day>", -5.755742213586912),
                                    ("<ordinal> <cycle> of <time>year (latent)",
                                     -5.755742213586912),
                                    ("the <day-of-month> (ordinal)this|last|next <cycle>",
                                     -5.350277105478748),
                                    ("hh:mmon <date>", -3.740839193044647),
                                    ("Saturdayyear (latent)", -5.755742213586912),
                                    ("from|since|after <time>on <date>", -4.839451481712757),
                                    ("absorption of , after named daySeptember",
                                     -4.839451481712757),
                                    ("Naraka Chaturdashiyear (latent)", -5.755742213586912),
                                    ("on <date>September", -5.350277105478748),
                                    ("at <time-of-day>on <date>", -5.350277105478748),
                                    ("dayweek", -4.657129924918802),
                                    ("Easter Sundayyear (latent)", -5.350277105478748),
                                    ("Thursday<time-of-day> am|pm", -4.657129924918802),
                                    ("weekyear", -4.3694478524670215),
                                    ...
                                    ("intersect by \",\", \"of\", \"from\" for yearhh:mm",
                                     -5.062595033026967),
                                    ("Sundayfrom|since|after <time>", -5.755742213586912),
                                    ("absorption of , after named dayFebruary", -4.839451481712757),
                                    ("July<integer> to|till|before <hour-of-day>",
                                     -5.755742213586912),
                                    ("tomorrowat <time-of-day>", -5.755742213586912),
                                    ("<integer> to|till|before <hour-of-day>July",
                                     -5.755742213586912),
                                    ("last <cycle> of <time>year (latent)", -5.062595033026967),
                                    ("tomorrow<time-of-day> am|pm", -5.755742213586912),
                                    ("<named-month> <day-of-month> (non ordinal)year (latent)",
                                     -5.062595033026967),
                                    ("Diwaliyear (latent)", -5.350277105478748),
                                    ("the <ordinal> last <cycle> of <time>year (latent)",
                                     -5.755742213586912),
                                    ("<time-of-day> - <time-of-day> (interval)July",
                                     -5.755742213586912),
                                    ("Fridayyear (latent)", -5.350277105478748),
                                    ("minuteyear", -4.502979245091544)],
                               n = 207}}),
       ("one eleven",
        Classifier{okData =
                     ClassData{prior = -1.3862943611198906,
       ...
       ("<integer> <unit-of-duration>",
        Classifier{okData =
                     ClassData{prior = -0.1916674192121923, unseen = -5.099866427824199,
                               likelihoods =
                                 HashMap.fromList
                                   [("week", -2.8965256234705428),
                                    ("integer (0..19)year (grain)", -3.0143086591269266),
                                    ("integer (numeric)day (grain)", -2.5288008433452256),
                                    ...
                                    ("integer (numeric)year (grain)", -3.3019907315787074),
                                    ("day", -2.260536856750546), ("year", -2.5288008433452256),
                                    ("integer (numeric)week (grain)", -3.484312288372662),
                                    ...
                                    ("integer (0..19)week (grain)", -3.484312288372662)],
                               n = 71},
                   koData =
                     ClassData{prior = -1.7462970951512977, unseen = -3.951243718581427,
                               likelihoods =
                                 HashMap.fromList
        ...
        Classifier{okData =
                   ...
                   koData =
                     ClassData{prior = -1.0296194171811581,
                               ...
                               likelihoods =
                                 HashMap.fromList
                                   [("week", -1.7047480922384253), ("dd/mm", -2.3978952727983707),
