...
classifiers
  = HashMap.fromList
      [("<time> timezone",
       ...
       ("integer (numeric)",
        Classifier{okData =
                     ClassData{prior = -0.8602012652231115, unseen = -4.897839799950911,
                               likelihoods = HashMap.fromList [("", 0.0)], n = 132},
                   koData =
                     ClassData{prior = -0.5500463369192721, unseen = -5.204006687076795,
       ...
       ("integer (0..19)",
        Classifier{okData =
                   ...
                   koData =
                     ClassData{prior = -1.6314168191528755,
       ...
       ("intersect",
        Classifier{okData =
                     ClassData{prior = -0.4689785138304903, unseen = -5.771441123130016,
                               likelihoods =
                                 HashMap.fromList
                                   [("<datetime> - <datetime> (interval)on <date>",
                                    ...
                                    ("dayhour", -2.8238820166273317),
                                    ("daymonth", -3.283414346005772),
                                    ("monthyear", -3.283414346005772),
                                    ("Mondayon <date>", -5.075173815233827),
                                    ("intersecthh:mm", -5.075173815233827),
                                    ("Wednesdaynext <cycle>", -5.075173815233827),
                                    ("Marchyear", -4.669708707125663),
                                    ("intersect by \"of\", \"from\", \"'s\"year",
                                     -4.669708707125663),
                                    ("Mondayintersect", -5.075173815233827),
                                    ("last <day-of-week> of <time>year", -4.669708707125663),
                                    ("todayat <time-of-day>", -4.669708707125663),
                                    ("Thursday<time> timezone", -3.822410846738459),
                                    ("dayday", -3.0602707946915624),
                                    ("dd/mmat <time-of-day>", -4.1588830833596715),
                                    ("the <day-of-month> (ordinal)February", -4.669708707125663),
                                    ("intersect by \",\"hh:mm", -4.1588830833596715),
                                    ("Mondaythe <day-of-month> (non ordinal)", -5.075173815233827),
                                    ("Thursdaybetween <time-of-day> and <time-of-day> (interval)",
                                     -5.075173815233827),
                                    ("dayyear", -3.3704257229954018),
                                    ("Thursdaybetween <datetime> and <datetime> (interval)",
                                     -5.075173815233827),
                                    ("Thursdayat <time-of-day>", -4.1588830833596715),
                                    ("tomorrow<time-of-day> sharp", -4.669708707125663),
                                    ...
                                    ("Thursdayfrom <time-of-day> - <time-of-day> (interval)",
                                     -4.669708707125663),
                                    ("tomorrowuntil <time-of-day>", -4.669708707125663),
                                    ("absorption of , after named day<day-of-month> (non ordinal) <named-month>",
                                     -4.382026634673881),
                                    ("the <day-of-month> (ordinal)March", -4.1588830833596715),
                                    ("after <time-of-day>at <time-of-day>", -4.669708707125663),
                                    ("intersect by \",\"<day-of-month> (non ordinal) <named-month>",
                                     -4.669708707125663),
                                    ("Mondaythe <day-of-month> (ordinal)", -5.075173815233827),
                                    ("tomorrowafter <time-of-day>", -4.669708707125663),
                                    ("from <time-of-day> - <time-of-day> (interval)on <date>",
                                     -4.1588830833596715),
                                    ("Sunday<day-of-month> (non ordinal) <named-month>",
                                     -5.075173815233827),
                                    ("dayminute", -2.5102244577722903),
                                    ("Tuesdaythis <time>", -4.382026634673881),
                                    ("from <datetime> - <datetime> (interval)on <date>",
                                     -4.382026634673881),
                                    ("minuteday", -2.472484129789443),
                                    ("absorption of , after named dayintersect",
                                     -5.075173815233827),
                                    ("Octoberyear", -3.6888794541139363),
                                    ("yearhh:mm", -5.075173815233827),
                                    ("absorption of , after named dayintersect by \",\"",
                                     -4.669708707125663),
                                    ("Septemberyear", -4.669708707125663),
                                    ("at <time-of-day>on <date>", -5.075173815233827),
                                    ("between <time-of-day> and <time-of-day> (interval)on <date>",
                                     -5.075173815233827),
                                    ("between <datetime> and <datetime> (interval)on <date>",
                                     -5.075173815233827),
                                    ("dayweek", -3.9765615265657175),
                                    ("hh:mmtomorrow", -4.382026634673881),
                                    ("Wednesdaythis <time>", -4.1588830833596715),
                                    ("tomorrowat <time-of-day>", -3.822410846738459),
                                    ("at <time-of-day>tomorrow", -4.669708707125663),
                                    ("intersectFebruary", -5.075173815233827),
                                    ("last <cycle> of <time>year", -4.669708707125663),
                                    ("Mondaythis <time>", -5.075173815233827),
                                    ("<day-of-month> (non ordinal) <named-month>year",
                                     -4.669708707125663),
                                    ("yearminute", -5.075173815233827)],
                               n = 122},
                   koData =
                     ClassData{prior = -0.9825401174153556, unseen = -5.407171771460119,
                               likelihoods =
                                 HashMap.fromList
                                   [("dayhour", -3.100092288878234),
                                    ("daymonth", -2.3116349285139637),
                                    ("monthyear", -3.20545280453606),
                                    ("Marchyear", -4.0163830207523885),
                                    ("intersect by \"of\", \"from\", \"'s\"year",
                                     -3.4567672328169663),
                                    ("Sundaythis <time>", -3.7932394694381792),
                                    ("absorption of , after named dayJuly", -4.304065093204169),
                                    ...
                                    ("Thursdaybetween <datetime> and <datetime> (interval)",
                                     -4.709530201312334),
                                    ("Thursdayat <time-of-day>", -3.20545280453606),
                                    ("Thursdayhh:mm", -4.304065093204169),
                                    ("WednesdayFebruary", -4.709530201312334),
                                    ("Thursdayfrom <datetime> - <datetime> (interval)",
                                     -4.304065093204169),
                                    ...
                                    ("dayminute", -3.004782109073909),
                                    ("Tuesdaythis <time>", -3.7932394694381792),
                                    ("<ordinal> <cycle> of <time>year", -4.304065093204169),
                                    ("minuteday", -3.20545280453606),
                                    ("Octoberyear", -4.304065093204169),
                                    ("hh:mmon <date>", -3.3232358401924436),
                                    ("Septemberyear", -4.304065093204169),
                                    ("weekyear", -3.7932394694381792),
                                    ("Wednesdaythis <time>", -3.4567672328169663),
                                    ("absorption of , after named dayFebruary", -4.304065093204169),
                                    ...
                                    ("last <cycle> of <time>year", -4.304065093204169),
                                    ("Mondaythis <time>", -4.304065093204169)],
                               n = 73}}),
                               ...
                               likelihoods =
                                 HashMap.fromList
                                   [("daymonth", -1.6094379124341003),
                                    ("Wednesdayintersect", -2.456735772821304),
                                    ("Wednesdaynext <cycle>", -2.8622008809294686),
                                    ("Tuesdaythis <cycle>", -2.8622008809294686),
                                    ("WednesdayOctober", -2.456735772821304),
                                    ("Wednesdaythis <cycle>", -2.8622008809294686),
                                    ("TuesdayOctober", -2.456735772821304),
                                    ("Mondaythis <cycle>", -2.8622008809294686),
                                    ("dayweek", -1.9459101490553135)],
                               n = 10},
                   koData =
                     ClassData{prior = -0.5108256237659907, unseen = -3.828641396489095,
                               likelihoods =
                                 HashMap.fromList
                                   [("Sundaylast <cycle>", -3.1135153092103742),
                                    ("daymonth", -1.0986122886681098),
                                    ("TuesdaySeptember", -2.70805020110221),
                                    ("Wednesdayintersect", -2.70805020110221),
                                    ("WednesdayOctober", -2.70805020110221),
                                    ("SundayMarch", -2.70805020110221),
                                    ("MondayMarch", -2.70805020110221),
                                    ("dayweek", -3.1135153092103742),
                                    ("Tuesdayintersect", -2.70805020110221),
                                    ("Sundayintersect", -2.70805020110221)],
                               n = 15}}),
       ("<duration> ago",
        Classifier{okData =
       ...
       ("last <cycle> of <time>",
        Classifier{okData =
                     ClassData{prior = -0.6931471805599453, unseen = -2.70805020110221,
                               likelihoods =
                                 HashMap.fromList
                                   [("day (grain)October", -1.540445040947149),
