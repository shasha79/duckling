...
classifiers
  = HashMap.fromList
      [("Bhai Dooj",
       ...
       ("integer (numeric)",
        Classifier{okData =
                     ClassData{prior = -0.6427768211709957, unseen = -5.659482215759621,
                               likelihoods = HashMap.fromList [("", 0.0)], n = 285},
                   koData =
                     ClassData{prior = -0.7461899165444263, unseen = -5.556828061699537,
       ...
       ("intersect",
        Classifier{okData =
                     ClassData{prior = -0.5114965395912242, unseen = -6.692083742506628,
                               likelihoods =
                                 HashMap.fromList
                                   [("Navaratriyear (latent)", -5.997695096858618),
                                    ...
                                    ("Octoberyear (latent)", -4.899082808190508),
                                    ...
                                    ("this <time>hh(:mm) - <time-of-day> am|pm",
                                     -5.997695096858618),
                                    ("yyyy-mm-ddhh:mm:ss", -5.592229988750454),
                                    ...
                                    ("<time-of-day> o'clockin|during the <part-of-day>",
                                     -5.997695096858618),
                                    ("Thursdayat <time-of-day>", -5.304547916298673),
                                    ...
                                    ("<day-of-month> (ordinal or number) of <named-month>in|during the <part-of-day>",
                                     -5.997695096858618),
                                    ("Septemberyear (latent)", -5.997695096858618),
                                    ...
                                    ("absorption of , after named dayintersect by \",\", \"of\", \"from\" for year",
                                     -5.997695096858618),
                                    ("last <cycle> of <time>year (latent)", -5.592229988750454),
                               ...
                               n = 298},
                   koData =
                     ClassData{prior = -0.9152852013721363, unseen = -6.410174881966167,
                               likelihoods =
                                 HashMap.fromList
                                   [("<time-of-day> - <time-of-day> (interval)on <date>",
                                     -4.799090878625398),
                                    ("hourday", -4.799090878625398),
                                    ("dayhour", -3.189652966191298),
                                    ("Tuesdayfrom|since|after <time>", -5.715381610499553),
                                    ("daymonth", -3.7004785899572883),
                                    ("monthyear", -4.010633518261128),
                                    ...
                                    ("Octoberyear (latent)", -4.799090878625398),
                                    ("<named-month>|<named-day> <day-of-month> (ordinal)year (latent)",
                                     -5.022234429939608),
                                    ...
                                    ("Septemberyear (latent)", -5.715381610499553),
                                    ...
                                    ("dayweek", -4.616769321831443),
                                    ("Easter Sundayyear (latent)", -5.309916502391388),
                                    ("Thursday<time-of-day> am|pm", -4.616769321831443),
                                    ("weekyear", -4.329087249379662),
                                    ...
                                    ("<integer> to|till|before <hour-of-day>July",
                                     -5.715381610499553),
                                    ("last <cycle> of <time>year (latent)", -5.022234429939608),
       ...
       ("year (latent)",
        Classifier{okData =
                     ClassData{prior = -0.2056689207909458, unseen = -4.882801922586371,
                               likelihoods =
                                 HashMap.fromList
                               ...
                               n = 127},
                   koData =
                     ClassData{prior = -1.682560177263063, unseen = -3.5263605246161616,
                               likelihoods =
                                 HashMap.fromList
                                   [("integer (numeric)", -0.7884573603642702),
                                    ("negative numbers", -0.9315582040049435),
                                    ("compose by multiplication", -2.1102132003465894)],
                               n = 29}}),
       ("mm/dd/yyyy",
        Classifier{okData =
                     ClassData{prior = 0.0, unseen = -1.3862943611198906,
       ...
       ("this|last|next <cycle>",
        Classifier{okData =
                     ClassData{prior = -0.6486954179891115, unseen = -4.634728988229636,
                               likelihoods =
                                 HashMap.fromList
                                   [("week", -1.4469189829363254),
                                    ("month (grain)", -2.322387720290225),
                                    ("year (grain)", -2.2270775404859005),
                                    ("week (grain)", -1.4469189829363254),
                                    ("quarter", -3.0155349008501706), ("year", -2.2270775404859005),
                                    ("month", -2.322387720290225),
                                    ("quarter (grain)", -3.0155349008501706)],
                               n = 46},
                   koData =
                     ClassData{prior = -0.7396671961948381, unseen = -4.553876891600541,
                               likelihoods =
                                 HashMap.fromList
       ...
       ("intersect by \",\", \"of\", \"from\", \"'s\"",
        Classifier{okData =
                     ClassData{prior = -0.5991182309116689, unseen = -4.897839799950911,
                               likelihoods =
                                 HashMap.fromList
                                   [("Wednesday<named-month> <day-of-month> (non ordinal)",
                                     -4.197201947661808),
                                    ("dayhour", -3.791736839553644),
                                    ...
                                    ("Black Fridaythis|last|next <cycle>", -4.197201947661808),
                                    ("<part-of-day> of <time>February", -4.197201947661808),
                                    ("Saturday<time-of-day> am|pm", -4.197201947661808),
                                    ("Martin Luther King's Daythis|last|next <cycle>",
                                     -3.791736839553644),
                                    ("on <date><time-of-day> am|pm", -4.197201947661808),
                                    ("hourmonth", -4.197201947661808),
                                    ("Fridayintersect by \",\", \"of\", \"from\" for year",
                                     -4.197201947661808),
                                    ("dayday", -2.325399770760217),
                                    ("the <day-of-month> (ordinal)February", -3.791736839553644),
                                    ("WednesdayOctober", -4.197201947661808),
                                    ("Wednesdaythis|last|next <cycle>", -3.791736839553644),
                                    ("intersect<named-month> <day-of-month> (non ordinal)",
                                     -3.2809112157876537),
                                    ("dayyear", -3.5040547671018634),
                                    ("Saturday<named-month> <day-of-month> (non ordinal)",
                                     -4.197201947661808),
                                    ("Thursdayhh:mm", -3.791736839553644),
                                    ("on <date><named-month> <day-of-month> (non ordinal)",
                                     -3.791736839553644),
                                    ("TuesdayOctober", -4.197201947661808),
                                    ("the <day-of-month> (ordinal)March", -4.197201947661808),
                                    ("Mondaythis|last|next <cycle>", -4.197201947661808),
                                    ("Fridayintersect", -4.197201947661808),
                                    ("Thursday<datetime> - <datetime> (interval)",
                                     -3.791736839553644),
                                    ("Thursday<time-of-day> - <time-of-day> (interval)",
                                     -3.791736839553644),
                                    ("Tuesdaythis|last|next <cycle>", -4.197201947661808),
                                    ("Sunday<named-month> <day-of-month> (non ordinal)",
                                     -4.197201947661808),
                                    ("dayminute", -2.810907586541918),
                                    ("minuteday", -3.2809112157876537),
                                    ("dayweek", -3.2809112157876537),
                                    ("Monday<named-month> <day-of-month> (non ordinal)",
                                     -3.791736839553644)],
                               n = 39},
                   koData =
                     ClassData{prior = -0.7969439742415888, unseen = -4.787491742782046,
                               likelihoods =
                                 HashMap.fromList
                                   [("week-endJuly", -4.085976312551584),
                                    ...
                                    ("this|last|next <cycle>Sunday", -4.085976312551584),
                                    ("Sundaythis|last|next <cycle>", -4.085976312551584),
                                    ("MondayMarch", -4.085976312551584),
                                    ("on <date>September", -3.6805112044434196),
                                    ("weekday", -4.085976312551584),
