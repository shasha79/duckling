...
classifiers
  = HashMap.fromList
      [("Military Spouse Day",
       ...
       ("integer (numeric)",
        Classifier{okData =
                     ClassData{prior = -0.6445152317219089, unseen = -5.762051382780177,
                               likelihoods = HashMap.fromList [("", 0.0)], n = 316},
                   koData =
                     ClassData{prior = -0.7442656344889684, unseen = -5.662960480135946,
       ...
       ("intersect",
        Classifier{okData =
                     ClassData{prior = -0.4850415066102762, unseen = -6.78897174299217,
                               likelihoods =
                                 HashMap.fromList
                                   [("Navaratriyear (latent)", -6.094697801749634),
                                    ...
                                    ("Octoberyear (latent)", -4.996085513081525),
                                    ...
                                    ("Thursday<time> timezone", -4.148787652694321),
                                    ...
                                    ("this <time>hh(:mm) - <time-of-day> am|pm",
                                     -6.094697801749634),
                                    ("yyyy-mm-ddhh:mm:ss", -5.68923269364147),
                                    ...
                                    ("<time-of-day> o'clockin|during the <part-of-day>",
                                     -6.094697801749634),
                                    ("Thursdayat <time-of-day>", -5.401550621189689),
                                    ...
                                    ("<day-of-month> (ordinal or number) of <named-month>in|during the <part-of-day>",
                                     -6.094697801749634),
                                    ("Septemberyear (latent)", -6.094697801749634),
                               ...
                               n = 330},
                   koData =
                     ClassData{prior = -0.9562579922812209, unseen = -6.461468176353717,
                               likelihoods =
                                 HashMap.fromList
                                   [("<time-of-day> - <time-of-day> (interval)on <date>",
                                     -4.850466541943434),
                                    ("hourday", -4.850466541943434),
                                    ("dayhour", -3.1276999442023308),
                                    ("Tuesdayfrom|since|after <time>", -5.766757273817589),
                                    ("daymonth", -3.751854253275325),
                                    ("monthyear", -4.062009181579164),
                                    ("<time-of-day> am|pmyear (latent)", -5.3612921657094255),
                                    ("Thai Pongalyear (latent)", -5.073610093257644),
                                    ("intersecthh:mm", -5.766757273817589),
                                    ("from <datetime> - <datetime> (interval)July",
                                     -5.766757273817589),
                                    ("houryear", -4.850466541943434),
                                    ("from <time-of-day> - <time-of-day> (interval)July",
                                     -5.766757273817589),
                                    ("<time-of-day> am|pmintersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.073610093257644),
                                    ("<time-of-day> am|pmintersect", -4.513994305322221),
                                    ("until <time>on <date>", -5.073610093257644),
                                    ("Octoberyear (latent)", -4.850466541943434),
                                    ("<named-month>|<named-day> <day-of-month> (ordinal)year (latent)",
                                     -5.073610093257644),
                                    ("about|exactly <time-of-day>year (latent)",
                                     -5.766757273817589),
                                    ("absorption of , after named dayJuly", -5.3612921657094255),
                                    ("from|since|after <time>July", -5.766757273817589),
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"year (latent)",
                                     -4.850466541943434),
                                    ("Clean Mondayyear (latent)", -5.766757273817589),
                                    ("monthhour", -5.766757273817589),
                                    ("hourmonth", -4.850466541943434),
                                    ("todayat <time-of-day>", -5.766757273817589),
                                    ("from|since|after <time>December", -5.766757273817589),
                                    ("from|since|after <time><time-of-day> am|pm",
                                     -5.766757273817589),
                                    ("Mondayyear (latent)", -4.66814498514948),
                                    ("dayday", -5.3612921657094255),
                                    ("mm/ddat <time-of-day>", -5.3612921657094255),
                                    ("<time-of-day> am|pmon <date>", -4.513994305322221),
                                    ("dayyear", -2.822318294651149),
                                    ("Thursdaymm/dd", -5.766757273817589),
                                    ("New Year's Dayyear (latent)", -5.3612921657094255),
                                    ("Thursdayfrom|since|after <time>", -4.062009181579164),
                                    ("Thursdayat <time-of-day>", -4.157319361383489),
                                    ("<integer> to|till|before <hour-of-day>September",
                                     -5.766757273817589),
                                    ("Aprilyear (latent)", -5.766757273817589),
                                    ("monthminute", -5.766757273817589),
                                    ("<time-of-day> am|pmtomorrow", -5.766757273817589),
                                    ("Thursdayhh:mm", -4.850466541943434),
                                    ("minutemonth", -3.9749978045895347),
                                    ("Augustyear (latent)", -5.3612921657094255),
                                    ("Thursdayfrom <datetime> - <datetime> (interval)",
                                     -5.3612921657094255),
                                    ("Thursdayfrom <time-of-day> - <time-of-day> (interval)",
                                     -5.3612921657094255),
                                    ("week-endin|during <named-month>|year", -5.766757273817589),
                                    ("mm/dd<time-of-day> - <time-of-day> (interval)",
                                     -5.3612921657094255),
                                    ("tomorrowfrom <time-of-day> - <time-of-day> (interval)",
                                     -5.766757273817589),
                                    ("Sundayyear (latent)", -4.850466541943434),
                                    ("Christmasat <time-of-day>", -5.766757273817589),
                                    ("from|since|after <time>year (latent)", -4.66814498514948),
                                    ("<duration> after|before|from <time>December",
                                     -5.766757273817589),
                                    ("yesterday<time-of-day> am|pm", -5.766757273817589),
                                    ("Septemberyear (latent)", -5.766757273817589),
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"hh:mm",
                                     -5.766757273817589),
                                    ("mm/ddyear (latent)", -5.766757273817589),
                                    ("Thursday<time-of-day> - <time-of-day> (interval)",
                                     -5.073610093257644),
                                    ...
                                    ("<ordinal> last <cycle> of <time>year (latent)",
                                     -5.3612921657094255),
                                    ("at <time-of-day>intersect", -5.3612921657094255),
                                    ("hh:mmyear (latent)", -4.66814498514948),
                                    ("Holiyear (latent)", -5.766757273817589),
                                    ("the <day-of-month> (ordinal)last <cycle> of <time>",
                                     -5.3612921657094255),
                                    ("until <time><time-of-day> am|pm", -5.766757273817589),
                                    ("at <time-of-day>intersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.766757273817589),
                                    ("dayminute", -2.994168551577808),
                                    ("yyyy-mm-ddhh:mm", -5.3612921657094255),
                                    ("intersectSeptember", -4.2626798770413155),
                                    ("minuteday", -2.698704338683972),
                                    ("absorption of , after named dayintersect",
                                     -5.766757273817589),
                                    ("Februaryin|during the <part-of-day>", -5.766757273817589),
                                    ("<ordinal> <cycle> of <time>year (latent)",
                                     -5.766757273817589),
                                    ("the <day-of-month> (ordinal)this|last|next <cycle>",
                                     -5.3612921657094255),
                                    ("hh:mmon <date>", -3.751854253275325),
                                    ("Saturdayyear (latent)", -5.766757273817589),
                                    ("from|since|after <time>on <date>", -4.850466541943434),
                                    ("absorption of , after named daySeptember",
                                     -4.850466541943434),
                                    ("Naraka Chaturdashiyear (latent)", -5.766757273817589),
                                    ("on <date>September", -5.3612921657094255),
                                    ("at <time-of-day>on <date>", -5.3612921657094255),
                                    ("dayweek", -4.66814498514948),
                                    ("Easter Sundayyear (latent)", -5.3612921657094255),
                                    ("Thursday<time-of-day> am|pm", -4.66814498514948),
                                    ("weekyear", -4.380462912697699),
                                    ...
                                    ("intersect by \",\", \"of\", \"from\" for yearhh:mm",
                                     -5.073610093257644),
                                    ("Sundayfrom|since|after <time>", -5.766757273817589),
                                    ("absorption of , after named dayFebruary", -4.850466541943434),
                                    ("July<integer> to|till|before <hour-of-day>",
                                     -5.766757273817589),
                                    ("tomorrowat <time-of-day>", -5.766757273817589),
                                    ("<integer> to|till|before <hour-of-day>July",
                                     -5.766757273817589),
                                    ("last <cycle> of <time>year (latent)", -5.073610093257644),
                                    ("tomorrow<time-of-day> am|pm", -5.766757273817589),
                                    ("<named-month> <day-of-month> (non ordinal)year (latent)",
                                     -5.073610093257644),
                                    ("Diwaliyear (latent)", -5.3612921657094255),
                                    ("the <ordinal> last <cycle> of <time>year (latent)",
                                     -5.766757273817589),
                                    ("<time-of-day> - <time-of-day> (interval)July",
                                     -5.766757273817589),
                                    ("Fridayyear (latent)", -5.3612921657094255),
                                    ("minuteyear", -4.513994305322221)],
                               n = 206}}),
       ("one eleven",
        Classifier{okData =
       ...
       ("year (latent)",
        Classifier{okData =
                     ClassData{prior = -0.17486281150627853,
                               ...
                               n = 157},
                   koData =
                     ClassData{prior = -1.8299112351924312,
       ...
       ("this|last|next <cycle>",
        Classifier{okData =
                     ClassData{prior = -0.6097655716208943, unseen = -4.709530201312334,
                               likelihoods =
                                 HashMap.fromList
                                   [("week", -1.5224265354444706),
                                    ("month (grain)", -2.3978952727983707),
                                    ("year (grain)", -1.9924301646902063),
                                    ("week (grain)", -1.5224265354444706),
                                    ("quarter", -3.0910424533583156), ("year", -1.9924301646902063),
                                    ("month", -2.3978952727983707),
                                    ("quarter (grain)", -3.0910424533583156)],
                               n = 50},
                   koData =
                     ClassData{prior = -0.7841189587656721, unseen = -4.553876891600541,
                               likelihoods =
                                 HashMap.fromList
       ...
       ("<integer> <unit-of-duration>",
        Classifier{okData =
                     ClassData{prior = -0.1868773733298153, unseen = -5.123963979403259,
                               likelihoods =
                                 HashMap.fromList
                                   [("week", -2.920769235080536),
                                    ("integer (0..19)year (grain)", -2.920769235080536),
                                    ("integer (numeric)day (grain)", -2.5530444549552183),
                                    ...
                                    ("integer (numeric)year (grain)", -3.172083663361442),
                                    ("day", -2.284780468360539), ("year", -2.409943611314545),
                                    ("integer (numeric)week (grain)", -3.508555899982655),
                                    ...
                                    ("integer (0..19)week (grain)", -3.508555899982655)],
                               n = 73},
                   koData =
                     ClassData{prior = -1.7692866133759966, unseen = -3.951243718581427,
                               likelihoods =
                                 HashMap.fromList
       ...
       ("intersect by \",\", \"of\", \"from\", \"'s\"",
        Classifier{okData =
                     ClassData{prior = -0.5663954749208014, unseen = -4.962844630259907,
                               likelihoods =
                                 HashMap.fromList
                                   [("Wednesday<named-month> <day-of-month> (non ordinal)",
                                     -4.2626798770413155),
                                    ("dayhour", -3.857214768933151),
                                    ("daymonth", -3.0099169085459474),
                                    ...
                                    ("Labor Daythis|last|next <cycle>", -4.2626798770413155),
                                    ("Black Fridaythis|last|next <cycle>", -4.2626798770413155),
                                    ("<part-of-day> of <time>February", -4.2626798770413155),
                                    ("Saturday<time-of-day> am|pm", -4.2626798770413155),
                                    ("Martin Luther King's Daythis|last|next <cycle>",
                                     -3.857214768933151),
                                    ("on <date><time-of-day> am|pm", -4.2626798770413155),
                                    ("hourmonth", -4.2626798770413155),
                                    ("Fridayintersect by \",\", \"of\", \"from\" for year",
                                     -4.2626798770413155),
                                    ("dayday", -2.390877700139724),
                                    ("the <day-of-month> (ordinal)February", -3.857214768933151),
                                    ("WednesdayOctober", -4.2626798770413155),
                                    ("Wednesdaythis|last|next <cycle>", -3.857214768933151),
                                    ("intersect<named-month> <day-of-month> (non ordinal)",
                                     -3.3463891451671604),
                                    ("dayyear", -3.0099169085459474),
                                    ("Saturday<named-month> <day-of-month> (non ordinal)",
                                     -4.2626798770413155),
                                    ("Thursdayhh:mm", -3.857214768933151),
                                    ("Thanksgiving Daythis|last|next <cycle>", -4.2626798770413155),
                                    ("Memorial Daythis|last|next <cycle>", -4.2626798770413155),
                                    ("on <date><named-month> <day-of-month> (non ordinal)",
                                     -3.857214768933151),
                                    ("TuesdayOctober", -4.2626798770413155),
                                    ("the <day-of-month> (ordinal)March", -4.2626798770413155),
                                    ("Mondaythis|last|next <cycle>", -4.2626798770413155),
                                    ("Fridayintersect", -4.2626798770413155),
                                    ("Thursday<datetime> - <datetime> (interval)",
                                     -3.857214768933151),
                                    ("Thursday<time-of-day> - <time-of-day> (interval)",
                                     -3.857214768933151),
                                    ("Tuesdaythis|last|next <cycle>", -4.2626798770413155),
                                    ("Sunday<named-month> <day-of-month> (non ordinal)",
                                     -4.2626798770413155),
                                    ("dayminute", -2.8763855159214247),
                                    ("minuteday", -3.3463891451671604),
                                    ("dayweek", -3.3463891451671604),
                                    ("Monday<named-month> <day-of-month> (non ordinal)",
                                     -3.857214768933151)],
                               n = 42},
                   koData =
                     ClassData{prior = -0.8383291904044432, unseen = -4.812184355372417,
                               likelihoods =
                                 HashMap.fromList
                                   [("week-endJuly", -4.110873864173311),
                                    ...
                                    ("this|last|next <cycle>Sunday", -4.110873864173311),
                                    ("Sundaythis|last|next <cycle>", -4.110873864173311),
                                    ("MondayMarch", -4.110873864173311),
                                    ("on <date>September", -3.7054087560651467),
                                    ("weekday", -4.110873864173311),
