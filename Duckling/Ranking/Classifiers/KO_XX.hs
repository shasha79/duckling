      ...
      [("<time> timezone",
       ...
       ("integer (numeric)",
        Classifier{okData =
                   ...
                   koData =
                     ClassData{prior = -0.9534302788236118, unseen = -4.330733340286331,
       ...
       ("intersect",
        Classifier{okData =
                     ClassData{prior = -0.4744579795951158, unseen = -5.932245187448011,
                               likelihoods =
                                 HashMap.fromList
                                   [("intersect<hour-of-day> <integer> (as relative minutes)",
                                     -5.236441962829949),
                                    ("intersectday-of-week", -4.137829674161839),
                                    ("year<time> \47560\51648\47561 <cycle>", -5.236441962829949),
                                    ("next <cycle>day-of-week", -4.320151230955794),
                                    ("dayhour", -1.997763510665569),
                                    ("monthday", -2.403228618773733),
                                    ("yearhour", -3.531693870591524),
                                    ("<time> <part-of-day>time-of-day", -4.320151230955794),
                                    ("intersectam|pm <time-of-day>", -3.0392173854937297),
                                    ("next <cycle><time-of-day> am|pm", -5.236441962829949),
                                    ("next <cycle>am|pm <time-of-day>", -4.830976854721785),
                                    ("yearintersect", -2.9338568698359033),
                                    ...
                                    ("monthday with korean number - \51068\51068..\44396\51068",
                                     -5.236441962829949),
                                    ("dayday-of-week", -4.320151230955794),
                                    ("this <cycle>day-of-week", -4.830976854721785),
                                    ("day-of-week<time> timezone", -4.830976854721785),
                                    ("monthhour", -3.531693870591524),
                                    ("mm/ddam|pm <time-of-day>", -4.543294782270004),
                                    ("todayam|pm <time-of-day>", -4.543294782270004),
                                    ("the day before yesterday - \50634\44536\51228am|pm <time-of-day>",
                                     -4.320151230955794),
                                    ("dayday", -3.6270040503958487),
                                    ("hourhour", -3.732364566053675),
                                    ("month<datetime> - <datetime> (interval)", -4.830976854721785),
                                    ("dayam|pm <time-of-day>", -5.236441962829949),
                                    ("day-of-weekam|pm <time-of-day>", -4.543294782270004),
                                    ("time-of-dayafter <time-of-day>", -5.236441962829949),
                                    ("monthminute", -4.830976854721785),
                                    ("hourminute", -4.543294782270004),
                                    ("intersectday", -4.137829674161839),
                                    ("am|pm <time-of-day>after <time-of-day>", -5.236441962829949),
                                    ("last <cycle>day-of-week", -5.236441962829949),
                                    ("month<time> <part-of-day>", -4.830976854721785),
                                    ("yearmonth", -3.2215389422876846),
                                    ("dayminute", -3.531693870591524),
                                    ("today<date>\50640", -5.236441962829949),
                                    ("mm/dd<date>\50640", -5.236441962829949),
                                    ("<hour-of-day> <integer> (as relative minutes)seconds",
                                     -5.236441962829949),
                                    ("<time> <part-of-day><date>\50640", -4.830976854721785),
                                    ("monthintersect", -3.6270040503958487),
                                    ("year<time> \47560\51648\47561 <day-of-week>",
                                     -5.236441962829949),
                                    ("intersectintersect", -3.4446824936018943),
                                    ("weekday", -3.8501476017100584),
                                    ("intersectday with korean number - \51068\51068..\44396\51068",
                                     -4.830976854721785),
                                    ("yearday", -3.4446824936018943),
                                    ("day-of-weekhh:mm", -4.830976854721785),
                                    ("minutesecond", -5.236441962829949),
                                    ("<time> <part-of-day><hour-of-day> <integer> (as relative minutes)",
                                     -4.830976854721785),
                                    ("tomorrow<time-of-day> am|pm", -5.236441962829949),
                                    ("tomorrowam|pm <time-of-day>", -4.830976854721785),
                                    ("dayintersect", -4.830976854721785),
                                    ("day-of-weektime-of-day", -5.236441962829949)],
                               n = 168},
                   koData =
                     ClassData{prior = -0.9734491457141037,
                               unseen = -5.6131281063880705,
                               likelihoods =
                                 HashMap.fromList
                                   [("year<time> \47560\51648\47561 <cycle>", -4.51085950651685),
                                    ("day-of-weekintersect", -4.916324614625014),
                                    ("dayhour", -2.277267285009756),
                                    ("monthday", -3.211576522386589),
                                    ("yearhour", -3.211576522386589),
                                    ("<time> <part-of-day>time-of-day", -3.817712325956905),
                                    ("houryear", -4.223177434065069),
                                    ("day-of-weekafter <time-of-day>", -4.916324614625014),
                                    ("after <time-of-day>by <time> - \44620\51648",
                                     -4.916324614625014),
                                    ("intersectam|pm <time-of-day>", -4.51085950651685),
                                    ("intersect<time> <part-of-day>", -4.000033882750859),
                                    ("yearintersect", -3.044522437723423),
                                    ("day-of-week<time-of-day> - <time-of-day> (interval)",
                                     -4.000033882750859),
                                    ("time-of-day<duration> ago", -4.916324614625014),
                                    ("this <cycle>day-of-week", -4.51085950651685),
                                    ("intersecttime-of-day", -4.51085950651685),
                                    ("monthhour", -3.044522437723423),
                                    ("intersectlast <time>", -4.916324614625014),
                                    ("dayday", -4.000033882750859),
                                    ("hourhour", -2.9704144655697013),
                                    ("year<time> <ordinal> <cycle>", -4.916324614625014),
                                    ("month<datetime> - <datetime> (interval)", -4.000033882750859),
                                    ("dayam|pm <time-of-day>", -4.51085950651685),
                                    ("day-of-weekam|pm <time-of-day>", -4.916324614625014),
                                    ("hourminute", -4.223177434065069),
                                    ("<time-of-day> - <time-of-day> (interval)last <time>",
                                     -4.000033882750859),
                                    ("intersectday", -4.51085950651685),
                                    ("last <cycle>day-of-week", -4.51085950651685),
                                    ("<datetime> - <datetime> (interval)day", -4.000033882750859),
                                    ("month<time> <part-of-day>", -4.51085950651685),
                                    ("yearmonth", -4.000033882750859),
                                    ("dayminute", -4.000033882750859),
                                    ("<time> <part-of-day><date>\50640", -4.916324614625014),
                                    ("last <time>time-of-day", -4.916324614625014),
                                    ("monthintersect", -3.41224721784874),
                                    ("hoursecond", -4.916324614625014),
                                    ("year<time> <part-of-day>", -4.51085950651685),
                                    ("intersectintersect", -3.6635616461296463),
                                    ("weekday", -4.000033882750859),
                                    ("intersectday with korean number - \51068\51068..\44396\51068",
                                     -4.51085950651685),
                                    ("day<time> <part-of-day>", -4.916324614625014),
                                    ("yearday", -3.817712325956905),
                                    ("day-of-weekhh:mm", -4.51085950651685),
                                    ("<time-of-day> - <time-of-day> (interval)time-of-day",
                                     -4.51085950651685),
                                    ("intersectafter <time-of-day>", -3.41224721784874),
                                    ("yearweek", -4.51085950651685),
                                    ("<time> <part-of-day><hour-of-day> <integer> (as relative minutes)",
                                     -4.51085950651685),
                                    ("dayintersect", -4.916324614625014),
                                    ("mm/ddafter <time-of-day>", -4.916324614625014),
                                    ("todayafter <time-of-day>", -4.916324614625014)],
                               n = 102}}),
       ("season",
        Classifier{okData =
                     ClassData{prior = 0.0, unseen = -1.3862943611198906,
                               ...
                               likelihoods =
                                 HashMap.fromList
                                   [("week", -2.0281482472922856),
                                    ...
                                    ("day", -1.6916760106710724), ("quarter", -2.9444389791664407),
                                    ("year", -2.9444389791664407), ("month", -2.9444389791664407),
                                    ("quarter (grain)", -2.9444389791664407),
                                    ("day (grain)", -1.6916760106710724)],
                               n = 13},
                   koData =
       ...
       ("week (grain)",
        Classifier{okData =
                     ClassData{prior = -0.9490805546971459, unseen = -2.639057329615259,
                               likelihoods = HashMap.fromList [("", 0.0)], n = 12},
                   koData =
                     ClassData{prior = -0.4895482253187058, unseen = -3.044522437723423,
       ...
       ("ordinals (\52395\48264\51704)",
        Classifier{okData =
                     ClassData{prior = -0.13353139262452263,
                               ...
                               likelihoods =
                                 HashMap.fromList
                                   [("integer (1..4) - for ordinals", -0.40546510810816444),
                                    ("integer (1..10) - TYPE 2", -1.0986122886681098)],
                               n = 7},
                   koData =
                     ClassData{prior = -2.0794415416798357,
                               unseen = -1.3862943611198906,
                               ...
                               likelihoods =
                                 HashMap.fromList
                                   [("integer (numeric)", -0.3629054936893685),
                                    ("intersect 2 numbers", -2.4423470353692043),
                                    ("integer (21..99) - TYPE 2", -2.4423470353692043)],
                               n = 17},
                   koData =
                     ClassData{prior = -0.40546510810816444,
       ...
       ("month",
        Classifier{okData =
                     ClassData{prior = -0.11441035117774422, unseen = -3.58351893845611,
                               likelihoods =
                                 HashMap.fromList
                                   [("integer (numeric)", -5.8840500022933465e-2),
                                    ("integer - TYPE 1", -2.8622008809294686)],
                               n = 33},
                   koData =
                               ...
                               likelihoods =
                                 HashMap.fromList
                                   [("integer (numeric)", -0.6931471805599453),
                                    ("integer - TYPE 1", -0.6931471805599453)],
                               n = 4}}),
        ...
        Classifier{okData =
                   ...
                   koData =
                     ClassData{prior = -0.3184537311185346,
                               ...
                               likelihoods =
                                 HashMap.fromList
                                   [("week", -1.2321436812926323),
                                    ("week (grain)", -1.2321436812926323),
       ...
       ("next n <cycle>",
        Classifier{okData =
                     ClassData{prior = -0.25131442828090605,
                               ...
                               likelihoods =
                                 HashMap.fromList
                                   [("integer - TYPE 1year (grain)", -2.639057329615259),
                                    ("integer - TYPE 1minute (grain)", -2.639057329615259),
                                    ("integer (1..4) - for ordinalsmonth (grain)",
                                     -2.639057329615259),
                                    ("integer (numeric)year (grain)", -2.639057329615259),
                                    ("year", -2.2335922215070942), ("hour", -2.639057329615259),
                                    ("month", -2.2335922215070942),
                                    ("integer (numeric)minute (grain)", -2.639057329615259),
                                    ("integer (numeric)month (grain)", -2.639057329615259),
                               ...
                               likelihoods =
                                 HashMap.fromList
                                   [("week", -1.791759469228055),
                                    ("integer - TYPE 1week (grain)", -2.1972245773362196),
                               ...
                               likelihoods =
                                 HashMap.fromList
                                   [("second", -2.4849066497880004),
                                    ("integer - TYPE 1minute (grain)", -2.890371757896165),
                                    ("integer (1..4) - for ordinalsmonth (grain)",
                                     -2.890371757896165),
                                    ("integer (1..4) - for ordinalshour (grain)",
                                     -2.890371757896165),
                                    ("integer (numeric)second (grain)", -2.890371757896165),
                                    ("integer (21..99) - TYPE 2hour (grain)", -2.890371757896165),
                                    ("hour", -1.9740810260220096), ("month", -2.4849066497880004),
                                    ("integer - TYPE 1second (grain)", -2.890371757896165),
                                    ("integer (numeric)minute (grain)", -2.890371757896165),
                                    ("integer (numeric)month (grain)", -2.890371757896165),
                                    ("minute", -2.4849066497880004),
                                    ("integer (numeric)hour (grain)", -2.4849066497880004)],
                               n = 10},
                   koData =
                     ClassData{prior = -1.791759469228055, unseen = -3.044522437723423,
                               likelihoods =
                                 HashMap.fromList
                                   [("week", -1.8971199848858813),
                                    ("integer - TYPE 1week (grain)", -2.3025850929940455),
       ...
       ("day-of-week",
        Classifier{okData =
                   ...
                   koData =
                     ClassData{prior = -2.995732273553991, unseen = -1.3862943611198906,
                               likelihoods = HashMap.fromList [("", 0.0)], n = 2}}),
       ("within <duration>",
        Classifier{okData =
                     ClassData{prior = 0.0, unseen = -1.6094379124341003,
