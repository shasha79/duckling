...
classifiers
  = HashMap.fromList
      [("<time> timezone",
       ...
       ("integer (numeric)",
        Classifier{okData =
                     ClassData{prior = -0.8964225286574299, unseen = -4.820281565605037,
                               likelihoods = HashMap.fromList [("", 0.0)], n = 122},
                   koData =
                     ClassData{prior = -0.5242938408168571, unseen = -5.187385805840755,
                               likelihoods = HashMap.fromList [("", 0.0)], n = 177}}),
       ...
       ("integer (0..19)",
        Classifier{okData =
                   ...
                   koData =
                     ClassData{prior = -1.491654876777717, unseen = -2.3978952727983707,
                               likelihoods = HashMap.fromList [("", 0.0)], n = 9}}),
       ...
       ("intersect",
        Classifier{okData =
                     ClassData{prior = -0.4670230011075977, unseen = -5.802118375377063,
                               likelihoods =
                                 HashMap.fromList
                                   [("Onsdagthis <cycle>", -5.10594547390058),
                                    ("Torsdag<time> timezone", -3.8531825054052127),
                                    ("<datetime> - <datetime> (interval)on <date>",
                                     -4.007333185232471),
                                    ("<time-of-day> - <time-of-day> (interval)on <date>",
                                     -4.007333185232471),
                                    ("hourday", -5.10594547390058),
                                    ("dayhour", -2.8546536752940854),
                                    ("daymonth", -2.96587931040431),
                                    ("monthyear", -3.4011973816621555),
                                    ("Torsdagbetween <time-of-day> and <time-of-day> (interval)",
                                     -5.10594547390058),
                                    ("Mandagon <date>", -5.10594547390058),
                                    ("yyyy-mm-ddat <time-of-day>", -4.412798293340635),
                                    ("intersecthh:mm", -5.10594547390058),
                                    ("Torsdagbetween <datetime> and <datetime> (interval)",
                                     -5.10594547390058),
                                    ("Torsdagat <time-of-day>", -4.189654742026425),
                                    ("Marsyear", -5.10594547390058),
                                    ("intersect by \"of\", \"from\", \"'s\"year",
                                     -4.700480365792417),
                                    ("Oktoberyear", -3.71965111278069),
                                    ("Torsdagfrom <time-of-day> - <time-of-day> (interval)",
                                     -4.700480365792417),
                                    ("Torsdagfrom <datetime> - <datetime> (interval)",
                                     -4.700480365792417),
                                    ("last <day-of-week> of <time>year", -5.10594547390058),
                                    ("todayat <time-of-day>", -4.700480365792417),
                                    ("the <day-of-month> (ordinal)Februari", -5.10594547390058),
                                    ("dayday", -3.2341432969989894),
                                    ("dd/mmat <time-of-day>", -4.189654742026425),
                                    ("intersect by \",\"hh:mm", -4.189654742026425),
                                    ("dayyear", -3.4965075614664802),
                                    ("tomorrow<time-of-day> sharp", -4.700480365792417),
                                    ("<day-of-month>(ordinal) <named-month>year",
                                     -4.700480365792417),
                                    ("Onsdag<named-month> <day-of-month> (non ordinal)",
                                     -5.10594547390058),
                                    ("Onsdagthis <time>", -4.412798293340635),
                                    ("absorption of , after named day<named-month> <day-of-month> (non ordinal)",
                                     -4.007333185232471),
                                    ("tomorrowuntil <time-of-day>", -4.700480365792417),
                                    ("absorption of , after named day<day-of-month> (non ordinal) <named-month>",
                                     -4.412798293340635),
                                    ("after <time-of-day>at <time-of-day>", -4.700480365792417),
                                    ("the <day-of-month> (ordinal)Mars", -4.007333185232471),
                                    ("intersect by \",\"<day-of-month> (non ordinal) <named-month>",
                                     -4.700480365792417),
                                    ("Mandagthis <cycle>", -5.10594547390058),
                                    ("tomorrowafter <time-of-day>", -4.700480365792417),
                                    ("from <time-of-day> - <time-of-day> (interval)on <date>",
                                     -4.189654742026425),
                                    ("dayminute", -2.431796824474052),
                                    ("from <datetime> - <datetime> (interval)on <date>",
                                     -4.412798293340635),
                                    ("on <date>Mars", -4.007333185232471),
                                    ("minuteday", -2.503255788456197),
                                    ("absorption of , after named dayintersect", -5.10594547390058),
                                    ("yearhh:mm", -5.10594547390058),
                                    ("Tisdagthis <time>", -4.700480365792417),
                                    ("Onsdagnext <cycle>", -5.10594547390058),
                                    ("absorption of , after named dayintersect by \",\"",
                                     -4.700480365792417),
                                    ("Septemberyear", -4.700480365792417),
                                    ("at <time-of-day>on <date>", -5.10594547390058),
                                    ("between <time-of-day> and <time-of-day> (interval)on <date>",
                                     -5.10594547390058),
                                    ("between <datetime> and <datetime> (interval)on <date>",
                                     -5.10594547390058),
                                    ("dayweek", -4.007333185232471),
                                    ("Tisdagthis <cycle>", -5.10594547390058),
                                    ("on <date>Februari", -5.10594547390058),
                                    ("hh:mmtomorrow", -4.412798293340635),
                                    ("tomorrowat <time-of-day>", -3.8531825054052127),
                                    ("at <time-of-day>tomorrow", -4.700480365792417),
                                    ("Sondag<day-of-month> (non ordinal) <named-month>",
                                     -5.10594547390058),
                                    ("last <cycle> of <time>year", -4.700480365792417),
                                    ("<day-of-month> (non ordinal) <named-month>year",
                                     -4.700480365792417),
                                    ("yearminute", -5.10594547390058)],
                               n = 126},
                   koData =
                     ClassData{prior = -0.9858167945227653, unseen = -5.43372200355424,
                               likelihoods =
                                 HashMap.fromList
                                   [("OnsdagFebruari", -4.736198448394496),
                                    ("dayhour", -2.790288299339182),
                                    ("daymonth", -2.338303175596125),
                                    ("monthyear", -3.2321210516182215),
                                    ("Torsdagbetween <time-of-day> and <time-of-day> (interval)",
                                     -4.736198448394496),
                                    ("Mandagon <date>", -4.330733340286331),
                                    ("yyyy-mm-ddat <time-of-day>", -4.04305126783455),
                                    ("Torsdagbetween <datetime> and <datetime> (interval)",
                                     -4.736198448394496),
                                    ("Torsdagat <time-of-day>", -3.2321210516182215),
                                    ("Marsyear", -4.04305126783455),
                                    ("intersect by \"of\", \"from\", \"'s\"year",
                                     -3.6375861597263857),
                                    ("Oktoberyear", -4.330733340286331),
                                    ("Torsdagfrom <time-of-day> - <time-of-day> (interval)",
                                     -4.736198448394496),
                                    ("Torsdagfrom <datetime> - <datetime> (interval)",
                                     -4.330733340286331),
                                    ("Mandagintersect", -4.330733340286331),
                                    ("absorption of , after named dayJuli", -4.330733340286331),
                                    ("hourmonth", -4.330733340286331),
                                    ("dd/mmat <time-of-day>", -3.8199077165203406),
                                    ("dayyear", -3.349904087274605),
                                    ("Onsdagthis <time>", -3.4834354798991276),
                                    ("Aprilyear", -4.736198448394496),
                                    ("yearmonth", -4.736198448394496),
                                    ("until <time-of-day>on <date>", -4.736198448394496),
                                    ("Torsdaghh:mm", -4.330733340286331),
                                    ("dayminute", -3.0314503561560704),
                                    ("<ordinal> <cycle> of <time>year", -4.330733340286331),
                                    ("minuteday", -3.2321210516182215),
                                    ("Tisdagthis <time>", -3.8199077165203406),
                                    ("hh:mmon <date>", -3.349904087274605),
                                    ("Sondaglast <cycle>", -4.736198448394496),
                                    ("Septemberyear", -4.330733340286331),
                                    ("dayweek", -4.736198448394496),
                                    ("on <date>Februari", -4.330733340286331),
                                    ("weekyear", -3.8199077165203406),
                                    ("absorption of , after named dayFebruari", -4.04305126783455),
                                    ("intersectFebruari", -4.330733340286331),
                                    ("last <cycle> of <time>year", -4.330733340286331),
                                    ("Mandagthis <time>", -4.736198448394496),
                                    ("Sondagthis <time>", -4.330733340286331)],
                               n = 75}}),
                               ...
                               likelihoods =
                                 HashMap.fromList
                                   [("week", -1.5040773967762742),
                                    ...
                                    ("quarter", -2.1972245773362196), ("year", -1.791759469228055),
                                    ("quarter (grain)", -2.1972245773362196)],
                               n = 6},
                   koData =
       ...
       ("year",
        Classifier{okData =
                     ClassData{prior = -0.5212969236332861, unseen = -3.044522437723423,
                               likelihoods = HashMap.fromList [("integer (numeric)", 0.0)],
                               n = 19},
                   koData =
                     ClassData{prior = -0.9007865453381898, unseen = -2.70805020110221,
                               likelihoods = HashMap.fromList [("integer (numeric)", 0.0)],
                               n = 13}}),
       ...
       ("intersect by \"of\", \"from\", \"'s\"",
        Classifier{okData =
                     ClassData{prior = -0.9985288301111273, unseen = -3.295836866004329,
                               likelihoods =
                                 HashMap.fromList
                                   [("daymonth", -1.3121863889661687),
                                    ("OnsdagOktober", -2.159484249353372),
                                    ("TisdagOktober", -2.159484249353372),
                   ...
                   koData =
                     ClassData{prior = -0.4595323293784402,
                               ...
                               likelihoods =
                                 HashMap.fromList
                                   [("daymonth", -1.0986122886681098),
                                    ("OnsdagOktober", -2.4849066497880004),
                                    ("Sondagintersect", -2.890371757896165),
                                    ("TisdagSeptember", -2.4849066497880004),
                                    ("Tisdagintersect", -2.4849066497880004),
                                    ("Onsdagintersect", -2.4849066497880004),
                                    ("SondagMars", -2.890371757896165),
                                    ("MandagMars", -2.890371757896165),
                                    ("Sondaglast <cycle>", -2.890371757896165),
                                    ("dayweek", -2.890371757896165)],
                               n = 12}}),
       ("<duration> ago",
        Classifier{okData =
                               ...
                               likelihoods =
                                 HashMap.fromList
                                   [("month (grain)", -2.0794415416798357),
                                    ...
                                    ("year", -1.3862943611198906), ("month", -2.0794415416798357)],
                               n = 4},
                   koData =
       ...
       ("last n <cycle>",
        Classifier{okData =
                     ClassData{prior = -0.1941560144409575, unseen = -3.891820298110627,
                               likelihoods =
                                 HashMap.fromList
                                   [("integer (0..19)year (grain)", -3.1780538303479458),
                                    ...
                                    ("integer (0..19)month (grain)", -2.772588722239781),
                                    ("integer (0..19)second (grain)", -3.1780538303479458),
                                    ("hour", -3.1780538303479458), ("month", -2.4849066497880004),
                               ...
                               n = 14},
                   koData =
                     ClassData{prior = -1.7346010553881064, unseen = -3.295836866004329,
                               likelihoods =
                                 HashMap.fromList
