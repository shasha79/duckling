...
classifiers
  = HashMap.fromList
      [("<time> timezone",
       ...
       ("integer (numeric)",
        Classifier{okData =
                     ClassData{prior = -0.41773520069997866, unseen = -4.02535169073515,
                               likelihoods = HashMap.fromList [("", 0.0)], n = 54},
                   koData =
                     ClassData{prior = -1.074514737089049, unseen = -3.4011973816621555,
       ...
       ("intersect",
        Classifier{okData =
                     ClassData{prior = -0.734646911466698, unseen = -5.384495062789089,
                               likelihoods =
                                 HashMap.fromList
                                   [("Tuesdayon <date>", -4.686750172980514),
                                    ("<hour-of-day> till thirdafter part of days",
                                     -4.28128506487235),
                                    ("dayhour", -3.770459441106359),
                                    ("daymonth", -4.686750172980514),
                                    ("in <named-month>on <date>", -4.686750172980514),
                                    ("monthyear", -3.5881378843124043),
                                    ("Mondayon <date>", -4.686750172980514),
                                    ("Christmasyear", -4.686750172980514),
                                    ("Monday<day-of-month> (ordinal or number) <named-month>",
                                     -4.686750172980514),
                                    ("month (integer)year (integer)", -4.28128506487235),
                                    ("<day-of-week> the last of <time><cycle> this|last|next",
                                     -4.686750172980514),
                                    ("at <time-of-day>before part of days", -3.993602992420569),
                                    ("hh:mmbefore part of days", -4.686750172980514),
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"year",
                                     -4.686750172980514),
                                    ("intersect<time> <part-of-day>", -4.28128506487235),
                                    ("dd/mm<time> <part-of-day>", -4.686750172980514),
                                    ("Thursday<time> timezone", -4.28128506487235),
                                    ("<hour-of-day> till quarterthis <part-of-day>",
                                     -4.28128506487235),
                                    ("dayday", -2.8949907037524594),
                                    ("absorption of , after named day<day-of-month> (ordinal or number) <named-month>",
                                     -4.686750172980514),
                                    ("hourhour", -3.5881378843124043),
                                    ("Thursday<day-of-month> (ordinal or number) <named-month>",
                                     -4.686750172980514),
                                    ("dayyear", -3.4339872044851463),
                                    ("Thursday<time> <part-of-day>", -4.686750172980514),
                                    ("<cycle> last of <time>year (integer)", -4.686750172980514),
                                    ("last <cycle> of <time>year (integer)", -4.686750172980514),
                                    ("<hour-of-day> quarterafter part of days", -4.686750172980514),
                                    ("minutehour", -2.3841650799864684),
                                    ("Thursdayfrom <datetime> - <datetime> (interval)",
                                     -4.686750172980514),
                                    ("Monday<cycle> this|last|next", -4.686750172980514),
                                    ("<day-of-month> (ordinal or number) of <named-month>year",
                                     -4.686750172980514),
                                    ("on a <named-day>dd/mm", -4.686750172980514),
                                    ("on a <named-day>on <date>", -4.686750172980514),
                                    ("on a <named-day><day-of-month> (ordinal or number) <named-month>",
                                     -4.686750172980514),
                                    ("Tuesday<cycle> this|last|next", -4.686750172980514),
                                    ("dayminute", -3.4339872044851463),
                                    ("dd/mmintersect", -4.686750172980514),
                                    ("in <named-month><cycle> this|last|next", -4.686750172980514),
                                    ("<hour-of-day> and integer minutesafter part of days",
                                     -4.28128506487235),
                                    ("Saturdaydd/mm", -4.686750172980514),
                                    ("at <time-of-day>after part of days", -3.5881378843124043),
                                    ("Tuesday<day-of-month> (ordinal or number) of <named-month>",
                                     -4.28128506487235),
                                    ("Septemberon <date>", -4.686750172980514),
                                    ("from <datetime> - <datetime> (interval)after part of days",
                                     -4.686750172980514),
                                    ("intersectintersect", -4.28128506487235),
                                    ("dayweek", -4.28128506487235),
                                    ("<datetime> - <datetime> (interval)after part of days",
                                     -4.686750172980514),
                                    ...
                                    ("<time-of-day> - <time-of-day> (interval)after part of days",
                                     -4.686750172980514),
                                    ("at <time-of-day>this <part-of-day>", -4.686750172980514),
                                    ("<hour-of-day> till thirdbefore part of days",
                                     -4.28128506487235)],
                               n = 59},
                   koData =
                     ClassData{prior = -0.6533012720127456, unseen = -5.429345628954441,
                               likelihoods =
                                 HashMap.fromList
                                   [("Tuesdayon <date>", -4.7318028369214575),
                                    ("in <named-month>year", -4.7318028369214575),
                                    ("dayhour", -3.2277254401451834),
                                    ("daymonth", -3.6331905482533475),
                                    ("monthday", -4.7318028369214575),
                                    ("monthyear", -2.6523612952416213),
                                    ("hh:mmafter part of days", -4.7318028369214575),
                                    ("houryear", -4.326337728813293),
                                    ("intersectat <time-of-day>", -3.8155121050473024),
                                    ("intersect<time> <part-of-day>", -4.326337728813293),
                                    ("month (ordinal)year (integer)", -4.7318028369214575),
                                    ("Octoberon <date>", -4.7318028369214575),
                                    ("until <time-of-day>after part of days", -4.7318028369214575),
                                    ("this|last <cycle>on <date>", -4.7318028369214575),
                                    ("Tuesdayafter <time-of-day>", -4.7318028369214575),
                                    ("Wednesdayon <date>", -4.326337728813293),
                                    ("dd/mm<time> <part-of-day>", -4.7318028369214575),
                                    ("yearyear", -4.326337728813293),
                                    ("<hour-of-day> till quarterthis <part-of-day>",
                                     -4.7318028369214575),
                                    ("dayday", -4.038655656361512),
                                    ("dd/mmat <time-of-day>", -4.326337728813293),
                                    ("hourhour", -4.326337728813293),
                                    ("month (integer)year", -4.7318028369214575),
                                    ("dayyear", -3.4790398684260895),
                                    ("Thursdayat <time-of-day>", -4.326337728813293),
                                    ("Februaryyear", -4.7318028369214575),
                                    ("<cycle> last of <time>year (integer)", -4.7318028369214575),
                                    ("minutemonth", -4.7318028369214575),
                                    ("minutehour", -4.326337728813293),
                                    ("for <duration> from <time>on <date>", -4.7318028369214575),
                                    ("<day-of-month> (ordinal or number) of <named-month>year",
                                     -4.326337728813293),
                                    ("<cycle> <ordinal> day? of <time>year", -4.7318028369214575),
                                    ("March<cycle> this|last|next", -4.7318028369214575),
                                    ("nth <time> of <time>year", -4.7318028369214575),
                                    ("Wednesday<day-of-month> (ordinal or number) of <named-month>",
                                     -4.7318028369214575),
                                    ("secondyear", -4.326337728813293),
                                    ("Wednesdayintersect by \",\", \"of\", \"from\", \"'s\"",
                                     -4.7318028369214575),
                                    ("on <date>year (integer)", -4.7318028369214575),
                                    ("<time> for <duration>year", -3.6331905482533475),
                                    ("<duration> after|before|from <time>on <date>",
                                     -4.7318028369214575),
                                    ("dayminute", -3.2277254401451834),
                                    ("Julyuntil <time-of-day>", -4.7318028369214575),
                                    ("intersecton <date>", -4.7318028369214575),
                                    ("the <cycle> the <ordinal> of <time>year",
                                     -4.7318028369214575),
                                    ("at <time-of-day>after part of days", -4.7318028369214575),
                                    ("<ordinal> <cycle> of <time>year", -4.7318028369214575),
                                    ("Sunday<cycle> this|last|next", -4.7318028369214575),
                                    ("Octoberyear", -4.7318028369214575),
                                    ("in|within|after <duration>year", -4.326337728813293),
                                    ("Tuesday<day-of-month> (ordinal or number) of <named-month>",
                                     -4.7318028369214575),
                                    ("on a <named-day>intersect", -4.326337728813293),
                                    ("Saturdayintersect", -4.326337728813293),
                                    ("at <time-of-day>year", -4.7318028369214575),
                                    ("on <date>year", -4.326337728813293),
                                    ("on <date>on <date>", -4.7318028369214575),
                                    ("weekday", -4.7318028369214575),
                                    ("dayweek", -4.7318028369214575),
                                    ("Tuesdaynth <time> of <time>", -4.7318028369214575),
                                    ("weekyear", -3.6331905482533475),
                                    ("Tuesdayintersect", -4.7318028369214575),
                                    ("after <time-of-day>year", -4.7318028369214575),
                                    ("in <number> (implicit minutes)February", -4.7318028369214575),
                                    ("last <cycle> of <time>year", -4.7318028369214575),
       ...
       ("ordinals (first..tenth)",
        Classifier{okData =
                   ...
                   koData =
                     ClassData{prior = -1.3668762752627892, unseen = -2.70805020110221,
                               ...
                               likelihoods =
                                 HashMap.fromList
                                   [("week", -2.367123614131617),
                                    ...
                                    ("year (grain)", -1.8562979903656263),
                                    ("week (grain)", -2.367123614131617),
                                    ("day", -2.0794415416798357), ("year", -1.8562979903656263),
                                    ("month", -2.0794415416798357),
                                    ("day (grain)", -2.0794415416798357)],
                               n = 12},
                   koData =
                     ClassData{prior = -0.7884573603642702, unseen = -3.367295829986474,
                               likelihoods =
                                 HashMap.fromList
                                   [("week", -0.9343092373768334),
                                    ("week (grain)", -0.9343092373768334)],
                               n = 10}}),
       ...
       ("month (integer)",
        Classifier{okData =
                     ClassData{prior = -0.10536051565782628,
                               ...
                               likelihoods =
                                 HashMap.fromList
                                   [("integer (numeric)", -1.791759469228055),
                                    ("integer 10", -0.6931471805599453),
                                    ("integer 3", -1.0986122886681098)],
                               n = 9},
                   koData =
                     ClassData{prior = -2.3025850929940455,
                               unseen = -1.6094379124341003,
                               likelihoods =
                                 HashMap.fromList [("integer 10", -0.6931471805599453)],
                               n = 1}}),
       ("year",
        Classifier{okData =
                   ...
                   koData =
                     ClassData{prior = -0.12516314295400605,
                               ...
                               likelihoods =
                                 HashMap.fromList
                                   [("integer (numeric)", -0.1941560144409575),
       ...
       ("intersect by \",\", \"of\", \"from\", \"'s\"",
        Classifier{okData =
                     ClassData{prior = -0.6931471805599453, unseen = -4.356708826689592,
                               likelihoods =
                                 HashMap.fromList
                                   [("dayhour", -2.5520459526256287),
                                    ("daymonth", -2.3978952727983707),
                                    ("monthyear", -2.7343675094195836),
                                    ("Wednesdayintersect", -3.6506582412937383),
                                    ("<named-month>|<named-day> <day-of-month> (ordinal)October",
                                     -3.6506582412937383),
                                    ("Wednesday<day-of-month> (ordinal or number) <named-month>",
                                     -3.6506582412937383),
                                    ("dayday", -2.7343675094195836),
                                    ("Thursday<day-of-month> (ordinal or number) <named-month>",
                                     -3.6506582412937383),
                                    ("in <named-month>year (integer)", -3.245193133185574),
                                    ("Thursdayat <time-of-day>", -3.6506582412937383),
                                    ("Thursday<time> <part-of-day>", -3.245193133185574),
                                    ("<named-month>|<named-day> <day-of-month> (ordinal)this|last the <cycle>",
                                     -3.6506582412937383),
                                    ("Tuesdaymonth (integer)", -3.6506582412937383),
                                    ("Wednesday<day-of-month> (ordinal or number) of <named-month>",
                                     -3.6506582412937383),
                                    ("Thursday<datetime> - <datetime> (interval)",
                                     -3.6506582412937383),
                                    ("Septemberyear (integer)", -3.6506582412937383),
                                    ("Thursday<time-of-day> - <time-of-day> (interval)",
                                     -3.6506582412937383),
                                    ("on a <named-day>September", -3.6506582412937383),
                                    ("Octoberyear (integer)", -3.6506582412937383),
                                    ("dayweek", -3.6506582412937383),
                                    ("Mondaythis|last the <cycle>", -3.6506582412937383),
                                    ("<named-month>|<named-day> <day-of-month> (ordinal)in <named-month>",
                                     -3.6506582412937383),
                                    ("Wednesdayin <named-month>", -3.6506582412937383)],
                               n = 20},
                   koData =
                     ClassData{prior = -0.6931471805599453, unseen = -4.356708826689592,
                               likelihoods =
                                 HashMap.fromList
                                   [("daymonth", -2.1465808445174646),
                                    ("TuesdaySeptember", -3.6506582412937383),
                                    ("monthyear", -2.5520459526256287),
                                    ("on a <named-day>intersect by \",\", \"of\", \"from\", \"'s\"",
                                     -3.6506582412937383),
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"year (integer)",
                                     -2.9575110607337933),
                                    ("dayyear", -2.5520459526256287),
                                    ("last <cycle> of <time>year (integer)", -3.6506582412937383),
                                    ("Monday<cycle> this|last|next", -3.6506582412937383),
                                    ("Wednesdayintersect by \",\", \"of\", \"from\", \"'s\"",
                                     -3.6506582412937383),
                                    ("Septemberyear (integer)", -3.245193133185574),
                                    ("on <date>year (integer)", -3.245193133185574),
                                    ("Octoberyear (integer)", -3.6506582412937383),
                                    ("Sunday<cycle> this|last|next", -3.6506582412937383),
                                    ("intersectyear (integer)", -3.6506582412937383),
                                    ("dayweek", -3.6506582412937383),
                                    ("Mondayin <named-month>", -3.6506582412937383),
                                    ("weekyear", -3.6506582412937383),
                               ...
                               likelihoods =
                                 HashMap.fromList
                                   [("week", -2.0794415416798357),
                                    ...
                                    ("day", -2.0794415416798357), ("year", -2.0794415416798357),
                                    ("month", -2.0794415416798357),
                                    ("day (grain)", -2.0794415416798357)],
                               n = 4},
                   koData =
       ...
       ("in <named-month>",
        Classifier{okData =
                     ClassData{prior = -7.410797215372185e-2,
                               ...
                               likelihoods =
                                 HashMap.fromList
                                   [("September", -2.3353749158170367),
                                    ("October", -1.824549292051046),
                                    ("February", -2.3353749158170367),
                                    ("March", -1.6422277352570913), ("month", -0.7949298748698876)],
                               n = 13},
                   koData =
                     ClassData{prior = -2.639057329615259, unseen = -2.0794415416798357,
                               likelihoods =
                                 HashMap.fromList
                                   [("October", -1.252762968495368), ("month", -1.252762968495368)],
                               n = 1}}),
       ("<time-of-day> - <time-of-day> (interval)",
        Classifier{okData =
                     ClassData{prior = -0.6931471805599453,
                               ...
                               likelihoods =
                                 HashMap.fromList
                                   [("week (grain)intersect by \",\", \"of\", \"from\", \"'s\"",
                                     -2.3025850929940455),
                                    ("week (grain)<time> for <duration>", -2.3025850929940455),
                                    ("weekmonth", -1.3862943611198906),
                                    ("weekday", -2.3025850929940455),
                                    ("week (grain)intersect", -2.3025850929940455),
                                    ("week (grain)Saturday", -2.3025850929940455),
                               ...
                               likelihoods =
                                 HashMap.fromList
                                   [("daymonth", -1.2039728043259361),
                                    ...
                                    ("day (grain)month (integer)", -1.6094379124341003)],
                               n = 2},
                   koData =
                     ClassData{prior = -0.6931471805599453,
                               unseen = -2.3978952727983707,
                               likelihoods =
                                 HashMap.fromList
                                   [("week (grain)month (ordinal)", -1.6094379124341003),
                                    ("weekmonth", -1.2039728043259361),
