...
classifiers
  = HashMap.fromList
      [("five",
       ...
       ("<ordinal> <cycle> <time>",
        Classifier{okData =
                     ClassData{prior = -0.9808292530117262, unseen = -2.772588722239781,
                               likelihoods =
                                 HashMap.fromList
                                   [("third ordinalday (grain)October", -2.0149030205422647),
                                    ("daymonth", -1.6094379124341003),
                                    ("quarteryear", -2.0149030205422647),
                                    ("third ordinalday (grain)on <date>", -2.0149030205422647),
                   ...
                   koData =
                     ClassData{prior = -0.4700036292457356, unseen = -2.995732273553991,
                               likelihoods =
                                 HashMap.fromList
                                   [("weekmonth", -1.1526795099383855),
                                    ("first ordinalweek (grain)intersect", -1.845826690498331),
                                    ("first ordinalweek (grain)October", -2.2512917986064953),
                                    ("first ordinalweek (grain)on <date>", -1.845826690498331)],
                               n = 5}}),
       ("<time> <part-of-day>",
        Classifier{okData =
       ...
       ("on <date>",
        Classifier{okData =
                     ClassData{prior = -0.19237189264745613,
                               ...
                               likelihoods =
                                 HashMap.fromList
                                   [("week", -2.833213344056216), ("Thursday", -3.3440389678222067),
                                    ("<time> <part-of-day>", -3.7495040759303713),
                                    ("September", -3.7495040759303713),
                                    ("October", -2.6508917872622613),
                                    ("intersect", -2.1400661634962708),
                                    ("Saturday", -3.3440389678222067),
                                    ("next <cycle>", -3.056356895370426),
                                    ("half to|till|before <integer> (hour-of-day)",
                                     -3.7495040759303713),
                                    ("day", -2.6508917872622613), ("afternoon", -3.056356895370426),
                                    ("this <cycle>", -2.833213344056216),
                                    ("year", -3.056356895370426), ("March", -3.7495040759303713),
                                    ("hour", -2.245426679154097), ("month", -1.8777018990287797),
                                    ("minute", -3.7495040759303713),
                                    ("this <time>", -3.7495040759303713)],
                               n = 33},
                   koData =
                     ClassData{prior = -1.742969305058623, unseen = -3.5263605246161616,
                               likelihoods =
                                 HashMap.fromList
                                   [("September", -2.803360380906535),
                                    ("October", -2.803360380906535),
                                    ("intersect", -2.3978952727983707),
                                    ("noon", -2.1102132003465894), ("hour", -2.1102132003465894),
       ...
       ("intersect",
        Classifier{okData =
                     ClassData{prior = -0.37776250555882857,
                               unseen = -6.2166061010848646,
                               likelihoods =
                                 HashMap.fromList
                                   [("Tuesdayon <date>", -4.605170185988091),
                                    ("Fridaynext <cycle>", -5.521460917862246),
                                    ...
                                    ("<time-of-day> - <time-of-day> (interval)on <date>",
                                     -5.115995809754082),
                                    ("hourday", -3.7297014486341915),
                                    ("dayhour", -2.659260036932778),
                                    ("daymonth", -3.7297014486341915),
                                    ("<time-of-day> popo\322udniu/wieczorem/w nocyabsorption of , after named day",
                                     -4.605170185988091),
                                    ("TuesdaySeptember", -5.521460917862246),
                                    ("monthyear", -3.3242363405260273),
                                    ("Wednesdayintersect", -5.115995809754082),
                                    ("from <hour-of-day> - <hour-of-day> (interval)on a named-day",
                                     -5.521460917862246),
                                    ("from <time-of-day> - <time-of-day> (interval)on a named-day",
                                     -5.521460917862246),
                                    ("intersecthh:mm", -5.521460917862246),
                                    ("from <datetime> - <datetime> (interval)on a named-day",
                                     -5.521460917862246),
                                    ("Wednesdaynext <cycle>", -5.115995809754082),
                                    ("Tuesdaythis <cycle>", -5.521460917862246),
                                    ("Saturday<time> <part-of-day>", -5.521460917862246),
                                    ("Marchyear", -5.115995809754082),
                                    ("Saturdayat <time-of-day>", -5.115995809754082),
                                    ("on a named-dayat <time-of-day>", -5.115995809754082),
                                    ("at <time-of-day>on a named-day", -5.521460917862246),
                                    ("<time> <part-of-day>on a named-day", -5.115995809754082),
                                    ("Wednesdayon <date>", -4.422848629194137),
                                    ("on a named-day<time> <part-of-day>", -5.521460917862246),
                                    ("last <day-of-week> of <time>year", -5.521460917862246),
                                    ("today<time> <part-of-day>", -5.521460917862246),
                                    ("todayat <time-of-day>", -5.521460917862246),
                                    ("on <date>at <time-of-day>", -5.115995809754082),
                                    ("dayday", -2.8824035882469876),
                                    ("on <date><time> <part-of-day>", -5.521460917862246),
                                    ("intersect by \",\"hh:mm", -4.605170185988091),
                                    ("mm/ddat <time-of-day>", -4.8283137373023015),
                                    ("WednesdayOctober", -5.115995809754082),
                                    ("last <cycle> <time>year", -5.115995809754082),
                                    ("intersect<named-month> <day-of-month> (non ordinal)",
                                     -4.8283137373023015),
                                    ("intersect<day-of-month> (non ordinal) <named-month>",
                                     -4.8283137373023015),
                                    ("dayyear", -3.506557897319982),
                                    ("Wednesday<day-of-month>(ordinal) <named-month>",
                                     -5.521460917862246),
                                    ("Thursday<time> <part-of-day>", -5.115995809754082),
                                    ...
                                    ("absorption of , after named day<day-of-month>(ordinal) <named-month>",
                                     -4.017383521085972),
                                    ("Tuesdaynext <cycle>", -5.521460917862246),
                                    ...
                                    ("Thursdayfrom <time-of-day> - <time-of-day> (interval)",
                                     -4.8283137373023015),
                                    ("tomorrowuntil <time-of-day>", -5.115995809754082),
                                    ("absorption of , after named day<day-of-month> (non ordinal) <named-month>",
                                     -4.017383521085972),
                                    ("<time-of-day> popo\322udniu/wieczorem/w nocyintersect by \",\"",
                                     -4.605170185988091),
                                    ("TuesdayOctober", -5.521460917862246),
                                    ("last <day-of-week> <time>year", -5.115995809754082),
                                    ("Monday<day-of-month>(ordinal) <named-month>",
                                     -5.115995809754082),
                                    ("Mondaythis <cycle>", -5.521460917862246),
                                    ("<time-of-day> ranoon <date>", -5.115995809754082),
                                    ("on <date><time-of-day> rano", -5.521460917862246),
                                    ...
                                    ("<time-of-day> popo\322udniu/wieczorem/w nocyFriday",
                                     -4.605170185988091),
                                    ("at <time-of-day>intersect", -5.115995809754082),
                                    ("dayminute", -3.912023005428146),
                                    ("<time-of-day> ranoon a named-day", -5.115995809754082),
                                    ("from <hour-of-day> - <hour-of-day> (interval)on <date>",
                                     -5.521460917862246),
                                    ("from <datetime> - <datetime> (interval)on <date>",
                                     -5.521460917862246),
                                    ("intersectyear", -5.115995809754082),
                                    ("on a named-day<time-of-day> rano", -5.521460917862246),
                                    ("minuteday", -2.322787800311565),
                                    ("absorption of , after named dayintersect",
                                     -5.521460917862246),
                                    ("Saturday<time-of-day> rano", -5.521460917862246),
                                    ("Octoberyear", -4.017383521085972),
                                    ("yearhh:mm", -5.521460917862246),
                                    ("at <time-of-day>intersect by \",\"", -5.115995809754082),
                                    ("absorption of , after named dayintersect by \",\"",
                                     -5.115995809754082),
                                    ("tomorrowexactly <time-of-day>", -4.8283137373023015),
                                    ("at <time-of-day>absorption of , after named day",
                                     -5.115995809754082),
                                    ("Septemberyear", -5.115995809754082),
                                    ("at <time-of-day>on <date>", -5.521460917862246),
                                    ("on <date>year", -4.422848629194137),
                                    ("dayweek", -3.7297014486341915),
                                    ("Tuesdayin <duration>", -5.521460917862246),
                                    ("<time> <part-of-day>on <date>", -5.115995809754082),
                                    ("tomorrowat <time-of-day>", -5.521460917862246),
                                    ("tomorrow<time> <part-of-day>", -5.521460917862246),
                                    ("at <time-of-day>Friday", -5.115995809754082),
                                    ("<time-of-day> popo\322udniu/wieczorem/w nocyintersect",
                                     -4.605170185988091),
                                    ("<named-month> <day-of-month> (ordinal)year",
                                     -5.521460917862246),
                                    ("tomorrow<time-of-day> rano", -5.521460917862246),
                                    ("<datetime> - <datetime> (interval)on a named-day",
                                     -5.115995809754082),
                                    ("last <cycle> of <time>year", -5.521460917862246),
                                    ...
                                    ("<hour-of-day> - <hour-of-day> (interval)on a named-day",
                                     -5.115995809754082),
                                    ("yearminute", -5.521460917862246)],
                               n = 183},
                   koData =
                     ClassData{prior = -1.1564318595569358, unseen = -5.713732805509369,
                               likelihoods =
                                 HashMap.fromList
                                   [("Tuesdayon <date>", -5.017279836814924),
                                    ("Sundaylast <cycle>", -4.61181472870676),
                                    ("<time-of-day> ranoby <time>", -4.61181472870676),
                                    ("Julyrelative minutes to|till|before <integer> (hour-of-day)",
                                     -5.017279836814924),
                                    ("dayhour", -3.9186675481468147),
                                    ("daymonth", -2.7146947438208784),
                                    ("monthyear", -3.312531744576499),
                                    ("Wednesdayintersect", -4.61181472870676),
                                    ("<time> <part-of-day>until <time-of-day>", -4.61181472870676),
                                    ("Marchyear", -4.324132656254979),
                                    ("Wednesdayon <date>", -5.017279836814924),
                                    ("absorption of , after named dayJuly", -5.017279836814924),
                                    ("<time> <part-of-day><time> <part-of-day>",
                                     -4.324132656254979),
                                    ("mm/ddat <time-of-day>", -5.017279836814924),
                                    ("last <cycle> <time>year", -4.61181472870676),
                                    ("hourhour", -4.100989104940769),
                                    ("<time> <part-of-day>by <time>", -4.61181472870676),
                                    ("dayyear", -3.7645168683195562),
                                    ("<time-of-day> ranoby the end of <time>", -4.61181472870676),
                                    ("<named-month> <day-of-month> (non ordinal)until <time-of-day>",
                                     -5.017279836814924),
                                    ("monthminute", -5.017279836814924),
                                    ("minutemonth", -4.324132656254979),
                                    ("Thursdayfrom <datetime> - <datetime> (interval)",
                                     -5.017279836814924),
                                    ("Thursdayfrom <time-of-day> - <time-of-day> (interval)",
                                     -5.017279836814924),
                                    ("Aprilyear", -5.017279836814924),
                                    ("<time-of-day> popo\322udniu/wieczorem/w nocyintersect by \",\"",
                                     -4.61181472870676),
                                    ("after <time-of-day>at <time-of-day>", -5.017279836814924),
                                    ("SundayMarch", -5.017279836814924),
                                    ("hh:mmby the end of <time>", -5.017279836814924),
                                    ("daysecond", -4.61181472870676),
                                    ("<time> <part-of-day>by the end of <time>", -4.61181472870676),
                                    ("<time> <part-of-day><time-of-day> rano", -5.017279836814924),
                                    ("<time-of-day> rano<time> <part-of-day>", -4.61181472870676),
                                    ("at <time-of-day>intersect", -5.017279836814924),
                                    ("dayminute", -4.61181472870676),
                                    ("<named-month> <day-of-month> (non ordinal)by <time>",
                                     -5.017279836814924),
                                    ("intersectyear", -3.7645168683195562),
                                    ("intersectSeptember", -4.324132656254979),
                                    ("<ordinal> <cycle> of <time>year", -5.017279836814924),
                                    ("minuteday", -3.312531744576499),
                                    ("Octoberyear", -4.61181472870676),
                                    ("hh:mmon <date>", -4.61181472870676),
                                    ("at <time-of-day>intersect by \",\"", -5.017279836814924),
                                    ("MondayMarch", -5.017279836814924),
                                    ("<named-month> <day-of-month> (non ordinal)by the end of <time>",
                                     -5.017279836814924),
                                    ("tomorrowexactly <time-of-day>", -5.017279836814924),
                                    ("hoursecond", -3.145477659913333),
                                    ("absorption of , after named daySeptember",
                                     -5.017279836814924),
                                    ("Septemberyear", -4.61181472870676),
                                    ("on <date>year", -4.61181472870676),
                                    ("hh:mmon a named-day", -4.61181472870676),
                                    ("dayweek", -4.61181472870676),
                                    ("weekyear", -3.7645168683195562),
                                    ("Sundayon <date>", -4.61181472870676),
                                    ("<ordinal> <cycle> <time>year", -4.61181472870676),
                                    ("absorption of , after named dayFebruary",
                                     -3.9186675481468147),
                                    ("hh:mmby <time>", -5.017279836814924),
                                    ("tomorrowat <time-of-day>", -5.017279836814924),
                                    ("minutesecond", -4.61181472870676),
                                    ("<time-of-day> popo\322udniu/wieczorem/w nocyintersect",
                                     -4.61181472870676),
                                    ("Tuesdayintersect", -4.61181472870676),
                                    ("Sundayintersect", -4.61181472870676),
       ...
       ("<ordinal> <cycle> of <time>",
        Classifier{okData =
                     ClassData{prior = -1.0986122886681098,
                               ...
                               likelihoods =
                                 HashMap.fromList
                                   [("third ordinalday (grain)October", -1.252762968495368),
                               ...
                               likelihoods =
                                 HashMap.fromList
                                   [("weekmonth", -1.0986122886681098),
                                    ("first ordinalweek (grain)intersect", -1.5040773967762742),
                                    ("first ordinalweek (grain)October", -1.5040773967762742)],
                               n = 2}}),
       ("season",
        Classifier{okData =
       ...
       ("this <cycle>",
        Classifier{okData =
                     ClassData{prior = -0.25131442828090605,
                               ...
                               likelihoods =
                                 HashMap.fromList
                                   [("week", -1.9740810260220096),
                                    ("year (grain)", -1.791759469228055),
                                    ("week (grain)", -1.9740810260220096),
                                    ("day", -2.4849066497880004), ("quarter", -2.1972245773362196),
       ...
       ("last <cycle> <time>",
        Classifier{okData =
                     ClassData{prior = -0.6931471805599453,
                               ...
                               likelihoods =
                                 HashMap.fromList
                                   [("day (grain)October", -2.1972245773362196),
                                    ("daymonth", -1.0986122886681098),
                                    ("day (grain)intersect", -1.791759469228055),
                                    ("day (grain)on <date>", -1.791759469228055)],
                               n = 5},
                   koData =
                     ClassData{prior = -0.6931471805599453,
                               unseen = -2.9444389791664407,
                               likelihoods =
                                 HashMap.fromList
                                   [("weekmonth", -1.0986122886681098),
                                    ...
                                    ("week (grain)on <date>", -1.791759469228055),
       ...
       ("last <cycle>",
        Classifier{okData =
                     ClassData{prior = -0.8266785731844679,
                               ...
                               likelihoods =
                                 HashMap.fromList
                                   [("month (grain)", -1.2992829841302609),
                                    ("year (grain)", -1.9924301646902063),
                                    ("year", -1.9924301646902063), ("month", -1.2992829841302609)],
                               n = 7},
                   koData =
                     ClassData{prior = -0.5753641449035618, unseen = -3.295836866004329,
                               likelihoods =
                                 HashMap.fromList
                                   [("week", -1.1786549963416462),
                                    ("week (grain)", -1.1786549963416462),
       ...
       ("next n <cycle>",
        Classifier{okData =
                     ClassData{prior = -0.15415067982725836,
                               ...
                               likelihoods =
                                 HashMap.fromList
                                   [("threemonth (grain)", -3.1135153092103742),
                                    ("threehour (grain)", -3.1135153092103742),
                                    ("integer (numeric)day (grain)", -3.1135153092103742),
                                    ("second", -2.70805020110221),
                                    ("threeday (grain)", -3.1135153092103742),
                                    ("threeyear (grain)", -3.1135153092103742),
                                    ("integer (numeric)second (grain)", -3.1135153092103742),
                                    ("integer (numeric)year (grain)", -3.1135153092103742),
                                    ("threesecond (grain)", -3.1135153092103742),
                                    ("day", -2.4203681286504293), ("year", -2.70805020110221),
                                    ("threeminute (grain)", -3.1135153092103742),
                                    ("hour", -2.70805020110221), ("month", -3.1135153092103742),
                                    ("integer (numeric)minute (grain)", -3.1135153092103742),
                                    ("a fewday (grain)", -3.1135153092103742),
                               ...
                               likelihoods =
                                 HashMap.fromList
                                   [("week", -2.120263536200091),
                                    ...
                                    ("threeweek (grain)", -2.5257286443082556)],
                               n = 2}}),
       ("15th ordinal",
        Classifier{okData =
                     ClassData{prior = 0.0, unseen = -1.9459101490553135,
       ...
       ("last n <cycle>",
        Classifier{okData =
                     ClassData{prior = -0.2076393647782445, unseen = -3.871201010907891,
                               likelihoods =
                                 HashMap.fromList
                                   [("integer (numeric)day (grain)", -2.751535313041949),
                                    ("twominute (grain)", -3.1570004211501135),
                                    ("second", -2.751535313041949),
                                    ("integer (numeric)second (grain)", -3.1570004211501135),
                                    ("twomonth (grain)", -3.1570004211501135),
                                    ("onehour (grain)", -3.1570004211501135),
                                    ("integer (numeric)year (grain)", -3.1570004211501135),
                                    ("day", -2.463853240590168), ("year", -2.751535313041949),
                                    ("twoday (grain)", -3.1570004211501135),
                                    ("hour", -2.751535313041949), ("month", -2.751535313041949),
                                    ("integer (numeric)minute (grain)", -3.1570004211501135),
                                    ("integer (numeric)month (grain)", -3.1570004211501135),
                                    ("minute", -2.751535313041949),
                                    ("twosecond (grain)", -3.1570004211501135),
                                    ("integer (numeric)hour (grain)", -3.1570004211501135),
                                    ("twoyear (grain)", -3.1570004211501135)],
                               n = 13},
                   koData =
                     ClassData{prior = -1.6739764335716716, unseen = -3.332204510175204,
                               likelihoods =
                                 HashMap.fromList
                                   [("week", -1.9095425048844386),
                                    ("twoweek (grain)", -2.6026896854443837),
