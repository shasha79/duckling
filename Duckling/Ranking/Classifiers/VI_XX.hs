...
classifiers
  = HashMap.fromList
      [("<time> timezone",
       ...
       ("integer (numeric)",
        Classifier{okData =
                     ClassData{prior = -0.5190392223033795, unseen = -4.59511985013459,
                               likelihoods = HashMap.fromList [("", 0.0)], n = 97},
                   koData =
                     ClassData{prior = -0.9040954587803368, unseen = -4.219507705176107,
                               ...
                               likelihoods =
                                 HashMap.fromList
                                   [("<time-of-day> s\225ng|chi\7873u|t\7889ing\224y dd/mm",
                                     -3.6309854756950335),
                                    ("hourday", -3.6309854756950335),
                                    ("dayhour", -4.324132656254979),
                                    ("h\244m nay<time-of-day> s\225ng|chi\7873u|t\7889i",
                                     -4.324132656254979),
                                    ("monthyear", -3.6309854756950335),
                                    ("Wednesdaynext <cycle>", -4.324132656254979),
                                    ("Tuesday<day-of-month> (numeric with day symbol) <named-month>",
                                     -4.324132656254979),
                                    ("time-of-day gi\7901<part-of-day> <time>", -4.324132656254979),
                                    ("Sunday<day-of-month> (numeric with day symbol) <named-month>",
                                     -3.9186675481468147),
                                    ("time-of-day gi\7901<time> n\224y", -4.324132656254979),
                                    ("month (numeric with month symbol)year (numeric with year symbol)",
                                     -3.9186675481468147),
                                    ("dayday", -2.6193845640165536),
                                    ("hourhour", -3.407841924380824),
                                    ("intersectyear (numeric with year symbol)",
                                     -3.6309854756950335),
                                    ("dayyear", -2.4523304793533875),
                                    ("minutehour", -3.9186675481468147),
                                    ("<time-of-day> s\225ng|chi\7873u|t\7889iintersect",
                                     -3.9186675481468147),
                                    ("Thursdaynext <cycle>", -3.9186675481468147),
                                    ("Octoberyear (numeric with year symbol)", -4.324132656254979),
                                    ...
                                    ("<time-of-day> s\225ng|chi\7873u|t\7889i<day-of-month> (numeric with day symbol) <named-month>",
                                     -3.407841924380824),
                                    ("time-of-day gi\7901tonight", -4.324132656254979),
                                    ("minuteday", -2.820055259478705),
                                    ("hh:mm<part-of-day> <time>", -4.324132656254979),
                                    ("<day-of-month> <named-month>year (numeric with year symbol)",
                                     -3.2255203675868693),
                                    ("Fridaythis <cycle>", -3.9186675481468147),
                                    ("Thursdaythis <cycle>", -4.324132656254979),
                                    ("at hh:mm<part-of-day> <time>", -4.324132656254979),
                                    ("dayweek", -3.071369687759611),
                                    ...
                                    ("Monday<day-of-month> (numeric with day symbol) <named-month>",
                                     -3.071369687759611),
                                    ("seasonthis <cycle>", -4.324132656254979),
                                    ("minuteyear", -3.9186675481468147)],
                               n = 51},
                   koData =
                     ClassData{prior = -0.866418901833982, unseen = -4.820281565605037,
                               likelihoods =
                                 HashMap.fromList
                                   [("<time-of-day> s\225ng|chi\7873u|t\7889ing\224y dd/mm",
                                     -4.119037174812472),
                                    ("hourday", -2.327277705584417),
                                    ("dayhour", -4.119037174812472),
                                    ("monthyear", -2.7327428136925813),
                                    ("noonh\244m nay", -4.119037174812472),
                                    ("houryear", -4.119037174812472),
                                    ("Mondaygi\225ng sinh", -3.0204248861443626),
                                    ("month (numeric with month symbol)year (numeric with year symbol)",
                                     -2.7327428136925813),
                                    ("dayday", -2.6149597780361984),
                                    ("dayyear", -4.119037174812472),
                                    ("<ordinal> <cycle> of <time>year (numeric with year symbol)",
                                     -4.119037174812472),
                                    ("h\244m naytime-of-day gi\7901", -4.119037174812472),
                                    ("minutehour", -3.713572066704308),
                                    ("Sundaygi\225ng sinh", -3.713572066704308),
                                    ("<part-of-day> <time>year (numeric with year symbol)",
                                     -4.119037174812472),
                                    ("<time-of-day> s\225ng|chi\7873u|t\7889igi\225ng sinh",
                                     -2.509599262378372),
                                    ("noonng\224y h\244m qua", -3.713572066704308),
                                    ("noongi\225ng sinh", -4.119037174812472),
                                    ("minuteday", -3.0204248861443626),
                                    ("hh:mm<part-of-day> <time>", -4.119037174812472),
                                    ("noonng\224y mai", -3.713572066704308),
                                    ("<day-of-month> <named-month>year (numeric with year symbol)",
                                     -4.119037174812472),
                                    ("at hh:mm<part-of-day> <time>", -4.119037174812472),
                                    ("weekyear", -4.119037174812472),
                                    ("Tuesdaygi\225ng sinh", -4.119037174812472)],
                               n = 37}}),
       ("time-of-day gi\7901",
        Classifier{okData =
                                 ...
                                 HashMap.fromList
                                   [("daymonth", -1.0986122886681098),
                                    ("day (grain)ordinalsmonth (numeric with month symbol)",
                                     -1.3862943611198906),
                                    ("day (grain)ordinalsMarch", -1.791759469228055)],
                               n = 3},
                   koData =
                     ClassData{prior = -0.916290731874155, unseen = -2.3978952727983707,
                               likelihoods =
                                 HashMap.fromList
                                   [("week (grain)ordinalsintersect", -1.6094379124341003),
       ...
       ("next <cycle>",
        Classifier{okData =
                     ClassData{prior = -0.7731898882334817, unseen = -3.713572066704308,
                               likelihoods =
                                 HashMap.fromList
                                   [("week", -2.0794415416798357),
                                    ...
                                    ("quarter", -2.3025850929940455), ("year", -2.0794415416798357),
                               ...
                               likelihoods =
                                 HashMap.fromList
                                   [("week", -3.0910424533583156),
                                    ...
                                    ("hour (grain)", -2.6855773452501515),
                                    ("year (grain)", -2.6855773452501515),
                                    ("second", -2.3978952727983707),
                                    ("week (grain)", -3.0910424533583156),
                                    ("day", -2.6855773452501515),
                                    ("minute (grain)", -2.6855773452501515),
                                    ("year", -2.6855773452501515),
       ...
       ("month (numeric with month symbol)",
        Classifier{okData =
                     ClassData{prior = -3.636764417087483e-2,
                               ...
                               n = 27},
                   koData =
                     ClassData{prior = -3.332204510175204, unseen = -1.3862943611198906,
                               likelihoods =
       ...
       ("this <cycle>",
        Classifier{okData =
                     ClassData{prior = -7.410797215372185e-2,
                               ...
                               likelihoods =
                                 HashMap.fromList
                                   [("week", -1.7346010553881064),
                                    ("year (grain)", -2.1400661634962708),
                                    ("week (grain)", -1.7346010553881064),
                               ...
                               likelihoods =
                                 HashMap.fromList
                                   [("month (grain)", -2.4849066497880004),
                                    ("year (grain)", -1.5686159179138452),
                                    ("year", -1.5686159179138452), ("month", -2.4849066497880004)],
                               n = 5},
                   koData =
                               ...
                               likelihoods =
                                 HashMap.fromList
                                   [("week", -2.70805020110221),
                                    ...
                                    ("week (grain)", -2.70805020110221), ("day", -2.70805020110221),
                                    ("minute (grain)", -2.70805020110221),
                                    ("year", -2.70805020110221),
                                    ("second (grain)", -2.70805020110221),
                                    ("hour", -2.70805020110221), ("month", -2.3025850929940455),
