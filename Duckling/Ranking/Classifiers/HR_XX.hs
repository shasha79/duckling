...
classifiers
  = HashMap.fromList
      [("<time> timezone",
       ...
       ("integer (numeric)",
        Classifier{okData =
                     ClassData{prior = -1.0462864696663698, unseen = -4.465908118654584,
                               likelihoods = HashMap.fromList [("", 0.0)], n = 85},
                   koData =
                     ClassData{prior = -0.4326919208083784,
       ...
       ("intersect",
        Classifier{okData =
                     ClassData{prior = -0.5134029447802911, unseen = -6.061456918928017,
                               likelihoods =
                                 HashMap.fromList
                                   [("u <named-day><day-of-month>(ordinal) <named-month>",
                                     -5.365976015021851),
                                    ("hourday", -4.9605109069136875),
                                    ("dd.mm<time-of-day> o'clock", -5.365976015021851),
                                    ("dayhour", -2.691827365595323),
                                    ("daymonth", -3.5742165457937967),
                                    ("u <named-day><named-month> <day-of-month> (ordinal)",
                                     -5.365976015021851),
                                    ("monthyear", -3.8618986182455775),
                                    ("Wednesdayintersect", -5.365976015021851),
                                    ("christmasyear", -5.365976015021851),
                                    ("Wednesdaynext <cycle>", -5.365976015021851),
                                    ("u <named-day><time-of-day> o'clock", -5.365976015021851),
                                    ("<time> <part-of-day>u <named-day>", -3.979681653901961),
                                    ("intersectat <time-of-day>", -5.365976015021851),
                                    ("Saturday<time> <part-of-day>", -4.9605109069136875),
                                    ("day before yesterdayat <time-of-day>", -4.672828834461907),
                                    ("Marchyear", -5.365976015021851),
                                    ("<named-day> <day-of-month> (ordinal)September",
                                     -4.9605109069136875),
                                    ("Saturdayat <time-of-day>", -4.9605109069136875),
                                    ("between <time-of-day> and <time-of-day> (interval)u <named-day>",
                                     -4.672828834461907),
                                    ("between <datetime> and <datetime> (interval)u <named-day>",
                                     -4.672828834461907),
                                    ("<time-of-day> o'clocktonight", -5.365976015021851),
                                    ("from <datetime> - <datetime> (interval)u <named-day>",
                                     -5.365976015021851),
                                    ("today<time> <part-of-day>", -4.9605109069136875),
                                    ...
                                    ("from <time-of-day> - <time-of-day> (interval)u <named-day>",
                                     -5.365976015021851),
                                    ("next <cycle>u <named-day>", -5.365976015021851),
                                    ("dayday", -3.1146842164153563),
                                    ("hourhour", -5.365976015021851),
                                    ("intersect<named-month> <day-of-month> (non ordinal)",
                                     -4.9605109069136875),
                                    ("Thursdaybetween <time-of-day> and <time-of-day> (interval)",
                                     -4.672828834461907),
                                    ("dayyear", -3.8618986182455775),
                                    ("Thursdaybetween <datetime> and <datetime> (interval)",
                                     -4.672828834461907),
                                    ("<time-of-day> o'clocktomorrow", -5.365976015021851),
                                    ("Thursday<time> <part-of-day>", -4.9605109069136875),
                                    ...
                                    ("absorption of , after named day<day-of-month>(ordinal) <named-month>",
                                     -3.979681653901961),
                                    ("day after tomorrow<time> <part-of-day>", -5.365976015021851),
                                    ("Thursdayhh:mm", -4.9605109069136875),
                                    ("minutemonth", -4.449685283147696),
                                    ("day after tomorrowat <time-of-day>", -4.9605109069136875),
                                    ...
                                    ("<named-day> <day-of-month> (ordinal)February",
                                     -4.113213046526484),
                                    ("this <cycle>u <named-day>", -4.9605109069136875),
                                    ("last <day-of-week> <time>year", -4.9605109069136875),
                                    ("dd.mmat <time-of-day>", -4.9605109069136875),
                                    ("intersect<day-of-month>(ordinal) <named-month>",
                                     -4.449685283147696),
                                    ("intersect<named-month> <day-of-month> (ordinal)",
                                     -4.9605109069136875),
                                    ("Saturday<time-of-day> o'clock", -5.365976015021851),
                                    ("day before yesterday<time-of-day> o'clock",
                                     -5.365976015021851),
                                    ("<time> <part-of-day><named-day> <day-of-month> (ordinal)",
                                     -4.449685283147696),
                                    ("dayminute", -3.168751437685632),
                                    ("u <named-day>at <time-of-day>", -4.9605109069136875),
                                    ("<time> <part-of-day>intersect", -3.4941738381202603),
                                    ("u <named-day><time> <part-of-day>", -4.9605109069136875),
                                    ("Tuesdayu <named-month>", -5.365976015021851),
                                    ("intersectyear", -5.365976015021851),
                                    ("intersectSeptember", -4.449685283147696),
                                    ("minuteday", -2.0701391490175225),
                                    ("absorption of , after named dayintersect",
                                     -5.365976015021851),
                                    ("<time> <part-of-day>intersect by \",\"", -4.449685283147696),
                                    ("Octoberyear", -4.449685283147696),
                                    ("intersect by \",\"at <time-of-day>", -4.449685283147696),
                                    ("absorption of , after named dayintersect by \",\"",
                                     -4.267363726353742),
                                    ("yearat <time-of-day>", -5.365976015021851),
                                    ("Septemberyear", -5.365976015021851),
                                    ("<time> <part-of-day>absorption of , after named day",
                                     -4.672828834461907),
                                    ("todaytonight", -5.365976015021851),
                                    ("weekday", -4.672828834461907),
                                    ("dayweek", -5.365976015021851),
                                    ("Wednesdayu <named-month>", -5.365976015021851),
                                    ("u <named-day><named-month> <day-of-month> (non ordinal)",
                                     -5.365976015021851),
                                    ("u <named-month>year", -4.9605109069136875),
                                    ("last <cycle> of <time>year", -5.365976015021851),
                                    ("<day-of-month> (non ordinal) <named-month>year",
                                     -5.365976015021851),
                                    ("yearminute", -5.365976015021851)],
                               n = 155},
                   koData =
                     ClassData{prior = -0.9124371625581651,
                               unseen = -5.7899601708972535,
                               likelihoods =
                                 HashMap.fromList
                                   [("since <time-of-day>by <time>", -4.400603020246817),
                                    ("year<time-of-day> - <time-of-day> (interval)",
                                     -5.093750200806762),
                                    ("hourday", -4.177459468932607),
                                    ("dayhour", -3.221948023905171),
                                    ("daymonth", -3.0788471802644977),
                                    ("monthday", -3.9951379121386528),
                                    ("monthyear", -3.3019907315787074),
                                    ("yearhour", -4.688285092698598),
                                    ("Wednesdayintersect", -5.093750200806762),
                                    ("hh:mmu <named-day>", -3.9951379121386528),
                                    ("last <time>today", -4.400603020246817),
                                    ("intersectat <time-of-day>", -5.093750200806762),
                                    ("Marchyear", -4.688285092698598),
                                    ("u <named-day>September", -5.093750200806762),
                                    ("<named-day> <day-of-month> (ordinal)September",
                                     -5.093750200806762),
                                    ("Thursdayafter <time-of-day>", -4.177459468932607),
                                    ("until <time-of-day>u <named-day>", -5.093750200806762),
                                    ("since <time-of-day>u <named-day>", -4.688285092698598),
                                    ("Sundayu <named-month>", -5.093750200806762),
                                    ("last <cycle>u <named-day>", -5.093750200806762),
                                    ("absorption of , after named dayJuly", -4.688285092698598),
                                    ("JanuaryWednesday", -5.093750200806762),
                                    ("Marchintersect", -5.093750200806762),
                                    ("dayday", -3.9951379121386528),
                                    ("<time> <part-of-day>at <time-of-day>", -5.093750200806762),
                                    ("monthmonth", -4.177459468932607),
                                    ("hourhour", -5.093750200806762),
                                    ("<time> <part-of-day>Thursday", -5.093750200806762),
                                    ("Thursdaybetween <time-of-day> and <time-of-day> (interval)",
                                     -4.688285092698598),
                                    ("dayyear", -4.400603020246817),
                                    ("Thursdaybetween <datetime> and <datetime> (interval)",
                                     -4.688285092698598),
                                    ("Thursday<time> <part-of-day>", -4.688285092698598),
                                    ("<time-of-day> - <time-of-day> (interval)u <named-day>",
                                     -5.093750200806762),
                                    ("FebruaryWednesday", -5.093750200806762),
                                    ("monthminute", -5.093750200806762),
                                    ("absorption of , after named day<day-of-month>(ordinal) <named-month>",
                                     -5.093750200806762),
                                    ("minutemonth", -4.688285092698598),
                                    ("MarchTuesday", -4.688285092698598),
                                    ("absorption of , after named day<named-month> <day-of-month> (ordinal)",
                                     -5.093750200806762),
                                    ...
                                    ("Julynumeral to|till|before <integer> (hour-of-day)",
                                     -5.093750200806762),
                                    ("Thursdaysince <time-of-day>", -4.177459468932607),
                                    ("dayminute", -3.0788471802644977),
                                    ("<time> <part-of-day>intersect", -4.688285092698598),
                                    ("Tuesdayu <named-month>", -5.093750200806762),
                                    ("intersectyear", -4.177459468932607),
                                    ("after <time-of-day>by <time>", -4.400603020246817),
                                    ("intersectSeptember", -4.688285092698598),
                                    ("<ordinal> <cycle> of <time>year", -5.093750200806762),
                                    ("minuteday", -3.0788471802644977),
                                    ("absorption of , after named dayintersect",
                                     -5.093750200806762),
                                    ("<time> <part-of-day>intersect by \",\"", -5.093750200806762),
                                    ("Octoberyear", -5.093750200806762),
                                    ("intersect by \",\"at <time-of-day>", -4.177459468932607),
                                    ("absorption of , after named dayintersect by \",\"",
                                     -5.093750200806762),
                                    ("yearat <time-of-day>", -5.093750200806762),
                                    ("absorption of , after named daySeptember",
                                     -4.688285092698598),
                                    ("Septemberyear", -5.093750200806762),
                                    ("weekday", -5.093750200806762),
                                    ("MarchMarch", -4.400603020246817),
                                    ("weekyear", -4.688285092698598),
                                    ("after <time-of-day>u <named-day>", -4.688285092698598),
                                    ("Wednesdayu <named-month>", -5.093750200806762),
                                    ("absorption of , after named dayFebruary", -5.093750200806762),
                                    ("hh:mmby <time>", -4.400603020246817),
                                    ("u <named-month>year", -3.9951379121386528),
                                    ("minutesecond", -3.484312288372662),
                                    ("Tuesdayintersect", -5.093750200806762),
                                    ("JanuaryTuesday", -5.093750200806762),
                                    ("Sundayintersect", -5.093750200806762),
                                    ("last <cycle> of <time>year", -5.093750200806762),
                                    ("Mondayu <named-month>", -5.093750200806762)],
                               n = 104}}),
       ("early morning",
        Classifier{okData =
                     ClassData{prior = 0.0, unseen = -1.791759469228055,
                               ...
                               likelihoods =
                                 HashMap.fromList
                                   [("week", -2.0794415416798357),
                                    ...
                                    ("day", -2.4849066497880004), ("quarter", -2.0794415416798357),
        ...
        Classifier{okData =
                               ...
                               likelihoods =
                                 HashMap.fromList
                                   [("Thursday", -1.791759469228055),
                                    ("absorption of , after named day", -2.4849066497880004),
                                    ("Wednesday", -2.4849066497880004),
                                    ("Saturday", -2.1972245773362196),
                                    ("Monday", -2.890371757896165), ("Friday", -2.890371757896165),
                   ...
                   koData =
                     ClassData{prior = -2.70805020110221, unseen = -2.3978952727983707,
                               likelihoods =
                                 HashMap.fromList
                                   [("day", -1.6094379124341003), ("Sunday", -1.6094379124341003)],
                               n = 1}}),
                               ...
                               likelihoods =
                                 HashMap.fromList
                                   [("month (grain)", -1.791759469228055),
                                    ...
                                    ("year", -1.3862943611198906), ("month", -1.791759469228055)],
                               n = 3},
                   koData =
                     ClassData{prior = -0.5596157879354228, unseen = -2.70805020110221,
                               likelihoods =
       ...
       ("next n <cycle>",
        Classifier{okData =
                     ClassData{prior = -0.2076393647782445, unseen = -3.891820298110627,
                               likelihoods =
                                 HashMap.fromList
                                   [("integer (0..19)year (grain)", -3.1780538303479458),
                                    ("integer (numeric)day (grain)", -3.1780538303479458),
                                    ("fewday (grain)", -3.1780538303479458),
                                    ("integer (0..19)hour (grain)", -3.1780538303479458),
                                    ("second", -2.772588722239781),
                                    ("integer (numeric)second (grain)", -3.1780538303479458),
                                    ("integer (numeric)year (grain)", -3.1780538303479458),
                                    ("day", -2.4849066497880004), ("year", -2.772588722239781),
                                    ("integer (0..19)month (grain)", -3.1780538303479458),
                                    ("integer (0..19)second (grain)", -3.1780538303479458),
                                    ...
                                    ("integer (numeric)month (grain)", -3.1780538303479458),
                                    ("minute", -2.772588722239781),
                                    ("integer (numeric)hour (grain)", -3.1780538303479458),
                                    ("integer (0..19)day (grain)", -3.1780538303479458)],
                               n = 13},
                   koData =
                     ClassData{prior = -1.6739764335716716, unseen = -3.367295829986474,
                               likelihoods =
                                 HashMap.fromList
                                   [("week", -1.9459101490553135),
                                    ("integer (numeric)week (grain)", -2.2335922215070942),
                                    ("integer (0..19)week (grain)", -2.639057329615259)],
                               n = 3}}),
       ("halloween day",
        Classifier{okData =
                     ClassData{prior = 0.0, unseen = -1.0986122886681098,
       ...
       ("last n <cycle>",
        Classifier{okData =
                     ClassData{prior = -0.17185025692665928,
                               ...
                               likelihoods =
                                 HashMap.fromList
                                   [("integer (0..19)year (grain)", -3.295836866004329),
                                    ...
                                    ("numbers ihour (grain)", -2.890371757896165),
                                    ...
                                    ("hour", -2.1972245773362196), ("month", -2.890371757896165),
                               ...
                               n = 16},
                   koData =
                     ClassData{prior = -1.845826690498331, unseen = -3.367295829986474,
                               likelihoods =
                                 HashMap.fromList
                                   [("week", -1.9459101490553135),
                                    ("integer (numeric)week (grain)", -2.2335922215070942),
